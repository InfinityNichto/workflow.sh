curl -u ":$PIXELDRAIN_API_KEY" https://pixeldrain.com/api/file/F6y7J6A4 -o idapro.7z
curl -u ":$PIXELDRAIN_API_KEY" https://pixeldrain.com/api/file/xrD55oSW -o libil2cpp.so.i64
