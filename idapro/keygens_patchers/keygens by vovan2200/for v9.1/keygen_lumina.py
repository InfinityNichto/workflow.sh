...
def getMacAddress():
    for n, item in enumerate(sorted(os.listdir('/sys/class/net/'))):
        addr = getHwAddr(item)
        ...
        'licenses': [
            {
                'id': '96-4137-ACAB-99',
                'owner': mac_address,
                'product_id': 'LUMINA_SERVER',
                'edition_id': 'lumina-server',
                'description': 'IDA Lumina Server',
...
def add_every_addon(license):
    addons = ['HEXX86', 'HEXX64', 'HEXARM', 'HEXARM64', 'HEXMIPS', 'HEXMIPS64', 'HEXPPC', 'HEXPPC64', 'HEXRV', 'HEXRV64', 'HEXARC', 'HEXARC64', "TEAMS", "LUMINA"]
...
pub_modulus_hexrays: int = buf_to_bigint(bytes.fromhex(''))
pub_modulus_patched: int = buf_to_bigint(bytes.fromhex(''))
private_key: int = buf_to_bigint(bytes.fromhex(''))
...
def patch_lumina_server(filename) -> None:
...
filename = 'lumina_server.hexlic'
with open(filename, 'w', encoding="utf-8", newline='\n') as f:
    f.write(serialized)
print(f'Saved new license to {filename}!')
patch_lumina_server('lumina_server')
