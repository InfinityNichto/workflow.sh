...
"""
MERGE_KIND_CUSTCNV = _ida_merge.MERGE_KIND_CUSTCNV
...
class merge_handler_params_t(object):
    ...
    label: str = property(_ida_merge.merge_handler_params_t_label_get,
...
"""
    mh_flags: int = property(_ida_merge.merge_handler_params_t_mh_flags_get,
        _ida_merge.merge_handler_params_t_mh_flags_set)
...
class moddata_diff_helper_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    module_name: str = property(_ida_merge.
...
"""
    netnode_name: str = property(_ida_merge.
...
"""
    additional_mh_flags: int = property(_ida_merge.
...
class merge_node_info_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    name: str = property(_ida_merge.merge_node_info_t_name_get, _ida_merge.
...
"""
    nds_flags: int = property(_ida_merge.merge_node_info_t_nds_flags_get,
        _ida_merge.merge_node_info_t_nds_flags_set)
