...
"""struct: fixed field offsets, stored in serialized form; cannot be set for unions 
        """
TAUDT_TUPLE = _ida_typeinf.TAUDT_TUPLE
...
class type_attr_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    key: str = property(_ida_typeinf.type_attr_t_key_get, _ida_typeinf.
        type_attr_t_key_set)
...
"""
    ...
    """number of base tils
"""
    flags: int = property(_ida_typeinf.til_t_flags_get, _ida_typeinf.
        til_t_flags_set)
...
"""
    nstreams: int = property(_ida_typeinf.til_t_nstreams_get, _ida_typeinf.
        til_t_nstreams_set)
...
class rrel_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    off: int = property(_ida_typeinf.rrel_t_off_get, _ida_typeinf.
        rrel_t_off_set)
...
"""usercall: locations of all arguments and the return value are explicitly specified 
        """
CM_CC_LAST_USERCALL = cvar.CM_CC_LAST_USERCALL
CM_CC_GOSTK = cvar.CM_CC_GOSTK
"""(Go) arguments and return value in stack
"""
CM_CC_FIRST_PLAIN_CUSTOM = cvar.CM_CC_FIRST_PLAIN_CUSTOM
...
"""
    return _ida_typeinf.is_custom_callcnv(cc)
...
def get_stkarg_area_info(out: 'stkarg_area_info_t', cc: 'callcnv_t') ->bool:
    """Some calling conventions foresee special areas on the stack for call arguments. This structure lists their sizes. 
        """
    return _ida_typeinf.get_stkarg_area_info(out, cc)
...
class stkarg_area_info_t(object):
    ...
    stkarg_offset: int = property(_ida_typeinf.
    ...
    """Offset from the SP to the first stack argument (can include linkage area) examples: pc: 0, hppa: -0x34, ppc aix: 0x18 
        """
    shadow_size: int = property(_ida_typeinf.
    ...
    """Size of the shadow area. explanations at: [https://stackoverflow.com/questions/30190132/what-is-the-shadow-space-in-x64-assembly](https://stackoverflow.com/questions/30190132/what-is-the-shadow-space-in-x64-assembly) examples: x64 Visual Studio C++: 0x20, x64 gcc: 0, ppc aix: 0x20 
        """
    linkage_area: int = property(_ida_typeinf.
...
class custom_callcnv_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    flags: 'uint64' = property(_ida_typeinf.custom_callcnv_t_flags_get,
        _ida_typeinf.custom_callcnv_t_flags_set)
    name: str = property(_ida_typeinf.custom_callcnv_t_name_get,
        _ida_typeinf.custom_callcnv_t_name_set)
    """the name is used as a keyword in the function prototype
"""
    abibits: int = property(_ida_typeinf.custom_callcnv_t_abibits_get,
        _ida_typeinf.custom_callcnv_t_abibits_set)
    """abibits to be used for the calling convention
"""

    def is_vararg(self) ->bool:
        return _ida_typeinf.custom_callcnv_t_is_vararg(self)

    def is_purging(self) ->bool:
        return _ida_typeinf.custom_callcnv_t_is_purging(self)

    def is_usercall(self) ->bool:
        return _ida_typeinf.custom_callcnv_t_is_usercall(self)
...
:param reterr: buffer for error message"""
        return _ida_typeinf.custom_callcnv_t_validate_func(self, fti, reterr)
...
:param fti: function prototype
:returns: success"""
        return _ida_typeinf.custom_callcnv_t_calc_retloc(self, fti)
...
:param fti: function prototype
:returns: success"""
        return _ida_typeinf.custom_callcnv_t_calc_arglocs(self, fti)

    def find_varargs(self, fti: 'func_type_data_t', call_ea:
        ida_idaapi.ea_t, blk: 'mblock_t *') ->'ssize_t':
...
:returns: >0 - total number of arguments after the call <0 - failure ==0 - means to use the standard algorithm to discover variadic args"""
        return _ida_typeinf.custom_callcnv_t_find_varargs(self, fti,
            call_ea, blk)

    def calc_varglocs(self, fti: 'func_type_data_t', regs: 'regobjs_t',
        stkargs: 'relobj_t', nfixed: int) ->bool:
...
:param call_ea: address of the call instruction (not used yet)"""
        return _ida_typeinf.custom_callcnv_t_calc_purged_bytes(self, *args)

    def decorate_name(self, name: str, should_decorate: bool, cc:
        'callcnv_t', type: 'tinfo_t') ->bool:
...
Decorate a function name. Some compilers decorate names depending on the calling convention. This function provides the means to handle it for custom callcnvs. Please note that this is about name decoration (C), not name mangling (C++). 
        """
        return _ida_typeinf.custom_callcnv_t_decorate_name(self, name,
            should_decorate, cc, type)
...
:returns: <0-failure, >=0-ok, 2-made substantial changes"""
        return _ida_typeinf.custom_callcnv_t_lower_func_type(self, fti)

    def __init__(self, *args):
        if self.__class__ == custom_callcnv_t:
            _self = None
        else:
            _self = self
        _ida_typeinf.custom_callcnv_t_swiginit(self, _ida_typeinf.
            new_custom_callcnv_t(_self, *args))
    __swig_destroy__ = _ida_typeinf.delete_custom_callcnv_t

    def __disown__(self):
        self.this.disown()
        _ida_typeinf.disown_custom_callcnv_t(self)
        return weakref.proxy(self)


_ida_typeinf.custom_callcnv_t_swigregister(custom_callcnv_t)
CCI_VARARG = _ida_typeinf.CCI_VARARG
"""is variadic?
"""
CCI_PURGE = _ida_typeinf.CCI_PURGE
"""purges arguments?
"""
CCI_USER = _ida_typeinf.CCI_USER
"""is usercall? not tested
"""


def get_custom_callcnv(callcnv: 'callcnv_t') ->'custom_callcnv_t const *':
    """Retrieve custom calling convention details.
"""
    return _ida_typeinf.get_custom_callcnv(callcnv)
...
:returns: CM_CC_INVALID is not found"""
    return _ida_typeinf.find_custom_callcnv(name)


def get_custom_callcnvs(names: 'qstrvec_t *', codes: 'callcnvs_t *'
    ) ->'size_t':
...
:returns: number of the calling conventions added to the output buffers"""
    return _ida_typeinf.get_custom_callcnvs(names, codes)
...
"""
    ...
    def append_registers(self, kind: 'callregs_t::reg_kind_t', first_reg:
        int, last_reg: int) ->None:
        return _ida_typeinf.callregs_t_append_registers(self, kind,
            first_reg, last_reg)
...
"""
HTI_STANDALONE = _ida_typeinf.HTI_STANDALONE
...
"""
PT_SYMBOL = _ida_typeinf.PT_SYMBOL
...
:returns: success"""
    return _ida_typeinf.decorate_name(*args)


def gen_decorate_name(name: str, should_decorate: bool, cc: 'callcnv_t',
    type: 'tinfo_t') ->str:
    """Generic function for decorate_name() (may be used in IDP modules)
"""
    return _ida_typeinf.gen_decorate_name(name, should_decorate, cc, type)
...
"""
        return _ida_typeinf.tinfo_t_get_udt_taudt_bits(self)

    def is_unaligned_struct(self) ->bool:
        """Is an unaligned struct.
"""
        return _ida_typeinf.tinfo_t_is_unaligned_struct(self)

    def is_msstruct(self) ->bool:
        """Is gcc msstruct attribute applied.
"""
        return _ida_typeinf.tinfo_t_is_msstruct(self)

    def is_cpp_struct(self) ->bool:
        """Is a c++ object, not simple pod type.
"""
        return _ida_typeinf.tinfo_t_is_cpp_struct(self)
...
"""
    ...
    def is_tuple(self) ->bool:
        """Is a tuple?
"""
        return _ida_typeinf.tinfo_t_is_tuple(self)
...
:param etf_flags: etf_flag_t"""
    ...
    def set_tuple(self, on: bool=True) ->'tinfo_code_t':
        ...
        """
        return _ida_typeinf.tinfo_t_set_tuple(self, on)
...
:param idx: the index in the funcarg array where the new funcarg should be placed. if the specified index cannot be honored because it would spoil the funcarg sorting order, it is silently ignored."""
    ...
    def set_func_cc(self, cc: 'callcnv_t', etf_flags: 'uint'=0
        ) ->'tinfo_code_t':
...
"""
TCMP_DEEP_UDT = _ida_typeinf.TCMP_DEEP_UDT
...
class simd_info_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    name: str = property(_ida_typeinf.simd_info_t_name_get, _ida_typeinf.
...
def calc_arglocs(fti: 'func_type_data_t') ->bool:
    return _ida_typeinf.calc_arglocs(fti)


def calc_varglocs(fti: 'func_type_data_t', regs: 'regobjs_t', stkargs:
    'relobj_t', nfixed: int) ->bool:
    return _ida_typeinf.calc_varglocs(fti, regs, stkargs, nfixed)
...
"""
    ...
    """Parent struct.
"""
    delta: int = property(_ida_typeinf.ptr_type_data_t_delta_get,
...
class array_type_data_t(object):
    ...
    """element type
"""
    base: int = property(_ida_typeinf.array_type_data_t_base_get,
        _ida_typeinf.array_type_data_t_base_set)
    """array base
"""
    nelems: int = property(_ida_typeinf.array_type_data_t_nelems_get,
...
class funcarg_t(object):
    ...
    """argument location
"""
    name: str = property(_ida_typeinf.funcarg_t_name_get, _ida_typeinf.
        funcarg_t_name_set)
    """argument name (may be empty)
"""
    cmt: str = property(_ida_typeinf.funcarg_t_cmt_get, _ida_typeinf.
        funcarg_t_cmt_set)
...
"""
    ...
    """argument type
"""
    flags: int = property(_ida_typeinf.funcarg_t_flags_get, _ida_typeinf.
        funcarg_t_flags_set)
...
class func_type_data_t(funcargvec_t):
    ...
    """Function type data property bits 
        """
    _new_callcnv: 'callcnv_t' = property(_ida_typeinf.
        func_type_data_t__new_callcnv_get, _ida_typeinf.
        func_type_data_t__new_callcnv_set)
...
"""
    ...
    """return location
"""
    stkargs: int = property(_ida_typeinf.func_type_data_t_stkargs_get,
...
"""
    ...
    """spoiled register information. if spoiled register info is present, it overrides the standard spoil info (eax, edx, ecx for x86) 
        """
    _old_cc: 'cm_t' = property(_ida_typeinf.func_type_data_t__old_cc_get,
        _ida_typeinf.func_type_data_t__old_cc_set)

    def get_explicit_cc(self) ->'callcnv_t':
        return _ida_typeinf.func_type_data_t_get_explicit_cc(self)

    def set_cc(self, cc: 'callcnv_t') ->None:
        return _ida_typeinf.func_type_data_t_set_cc(self, cc)
    ...
    def is_user_cc(self) ->bool:
        return _ida_typeinf.func_type_data_t_is_user_cc(self)
...
class edm_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    name: str = property(_ida_typeinf.edm_t_name_get, _ida_typeinf.
        edm_t_name_set)
    cmt: str = property(_ida_typeinf.edm_t_cmt_get, _ida_typeinf.edm_t_cmt_set)
...
class enum_type_data_t(edmvec_t):
    ...
    """if present, specifies bitmask group sizes each non-trivial group starts with a mask member 
        """
    taenum_bits: int = property(_ida_typeinf.
...
"""
    name: str = property(_ida_typeinf.typedef_type_data_t_name_get,
        _ida_typeinf.typedef_type_data_t_name_set)
    """is_ordref=false: target type name. we do not own this pointer!
"""
    ordinal: int = property(_ida_typeinf.typedef_type_data_t_ordinal_get,
        _ida_typeinf.typedef_type_data_t_ordinal_set)
...
class value_repr_t(object):
    ...
    """FRB_OFFSET.
"""
    strtype: int = property(_ida_typeinf.value_repr_t_strtype_get,
...
"""
    ...
    """FRB_STROFF.
"""
    type_ordinal: int = property(_ida_typeinf.value_repr_t_type_ordinal_get,
        _ida_typeinf.value_repr_t_type_ordinal_set)
    """FRB_STROFF, FRB_ENUM.
"""
...
"""
    ...
    """size in bits
"""
    name: str = property(_ida_typeinf.udm_t_name_get, _ida_typeinf.
        udm_t_name_set)
    """member name
"""
    cmt: str = property(_ida_typeinf.udm_t_cmt_get, _ida_typeinf.udm_t_cmt_set)
    """member comment
"""
...
"""
    effalign: int = property(_ida_typeinf.udm_t_effalign_get, _ida_typeinf.
        udm_t_effalign_set)
    """effective field alignment (in bytes)
"""
    tafld_bits: int = property(_ida_typeinf.udm_t_tafld_bits_get,
...
"""
    ...
    def compare_with(self, r: 'udm_t', tcflags: int) ->bool:
        return _ida_typeinf.udm_t_compare_with(self, r, tcflags)
...
"""
    effalign: int = property(_ida_typeinf.udt_type_data_t_effalign_get,
        _ida_typeinf.udt_type_data_t_effalign_set)
    """effective structure alignment (in bytes)
"""
    taudt_bits: int = property(_ida_typeinf.udt_type_data_t_taudt_bits_get,
        _ida_typeinf.udt_type_data_t_taudt_bits_set)
    """TA... and TAUDT... bits.
"""
...
"""
    ...
    def is_tuple(self) ->bool:
        return _ida_typeinf.udt_type_data_t_is_tuple(self)
    ...
    def set_tuple(self, on: bool=True) ->None:
        return _ida_typeinf.udt_type_data_t_set_tuple(self, on)
...
class type_mods_t(object):
    ...
    """current type
"""
    name: str = property(_ida_typeinf.type_mods_t_name_get, _ida_typeinf.
        type_mods_t_name_set)
    """current type name
"""
    cmt: str = property(_ida_typeinf.type_mods_t_cmt_get, _ida_typeinf.
        type_mods_t_cmt_set)
    """comment for current type
"""
    flags: int = property(_ida_typeinf.type_mods_t_flags_get, _ida_typeinf.
...
class valstr_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    oneline: str = property(_ida_typeinf.valstr_t_oneline_get, _ida_typeinf
...
class til_symbol_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    name: str = property(_ida_typeinf.til_symbol_t_name_get, _ida_typeinf.
...
"""
    return _ida_typeinf.calc_retloc(*args)
...
class til_type_ref_t(object):
    ...
    ordinal: int = property(_ida_typeinf.til_type_ref_t_ordinal_get,
    ...
    is_forward: bool = property(_ida_typeinf.til_type_ref_t_is_forward_get,
        _ida_typeinf.til_type_ref_t_is_forward_set)
...
def register_custom_callcnv(cnv_incref: 'custom_callcnv_t'
    ) ->'custom_callcnv_t *':
...
* the calling convention is special (usercall, purging, vararg) and there are too many of them already"""
    return _ida_typeinf.register_custom_callcnv(cnv_incref)


def unregister_custom_callcnv(cnv_decref: 'custom_callcnv_t'
    ) ->'custom_callcnv_t *':
    """Unregister a calling convention 
        
:returns: true if successfully unregistered the custom calling convention"""
    return _ida_typeinf.unregister_custom_callcnv(cnv_decref)
...
PT_STANDALONE = _ida_typeinf.PT_STANDALONE
