...
"""
    ...
    value: int = property(_ida_ua.op_t_value_get, _ida_ua.op_t_value_set)
...
"""
    ...
    addr: ida_idaapi.ea_t = property(_ida_ua.op_t_addr_get, _ida_ua.
        op_t_addr_set)
    """virtual address pointed or used by the operand. (o_mem,o_displ,o_far,o_near) 
        """
    specval: ida_idaapi.ea_t = property(_ida_ua.op_t_specval_get, _ida_ua.
        op_t_specval_set)
...
class insn_t(object):
    ...
    cs: ida_idaapi.ea_t = property(_ida_ua.insn_t_cs_get, _ida_ua.insn_t_cs_set
        )
    """Current segment base paragraph. Initialized by the kernel.
"""
    ip: ida_idaapi.ea_t = property(_ida_ua.insn_t_ip_get, _ida_ua.insn_t_ip_set
        )
    """Virtual address of the instruction (address within the segment). Initialized by the kernel. 
        """
    ea: ida_idaapi.ea_t = property(_ida_ua.insn_t_ea_get, _ida_ua.insn_t_ea_set
        )
    ...
    """Size of instruction in bytes. The analyzer should put here the actual size of the instruction. 
        """
    auxpref: int = property(_ida_ua.insn_t_auxpref_get, _ida_ua.
        insn_t_auxpref_set)
...
"""x.dtype contains correct variable type (for insns like 'lea' this bit must be off). in general, dr_O references do not allow to determine the variable size 
        """
STKVAR_KEEP_EXISTING = _ida_ua.STKVAR_KEEP_EXISTING
...
class outctx_base_t(object):
    ...
    __repr__ = _swig_repr
    insn_ea: ida_idaapi.ea_t = property(_ida_ua.outctx_base_t_insn_ea_get,
        _ida_ua.outctx_base_t_insn_ea_set)
    outbuf: str = property(_ida_ua.outctx_base_t_outbuf_get, _ida_ua.
...
"""
    ...
    def display_hidden(self) ->bool:
        return _ida_ua.outctx_base_t_display_hidden(self)
...
"""
CTXF_UNHIDE = _ida_ua.CTXF_UNHIDE
...
class outctx_t(outctx_base_t):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError('No constructor defined')
    __repr__ = _swig_repr
    bin_ea: ida_idaapi.ea_t = property(_ida_ua.outctx_t_bin_ea_get, _ida_ua
        .outctx_t_bin_ea_set)
    ...
    insn: 'insn_t' = property(_ida_ua.outctx_t_insn_get, _ida_ua.
        outctx_t_insn_set)
    curlabel: str = property(_ida_ua.outctx_t_curlabel_get, _ida_ua.
    ...
    prefix_ea: ida_idaapi.ea_t = property(_ida_ua.outctx_t_prefix_ea_get,
        _ida_ua.outctx_t_prefix_ea_set)
    next_line_ea: ida_idaapi.ea_t = property(_ida_ua.
        outctx_t_next_line_ea_get, _ida_ua.outctx_t_next_line_ea_set)
