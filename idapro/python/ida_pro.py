...
def bitcountr_zero(x: 'uint64') ->int:
    """count the number of consecutive trailing zero bits (line C++20 std::countr_zero()) 
        """
    return _ida_pro.bitcountr_zero(x)
...
class channel_redir_t(object):
    ...
    """channel number
"""
    file: str = property(_ida_pro.channel_redir_t_file_get, _ida_pro.
...
class instant_dbgopts_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    debmod: str = property(_ida_pro.instant_dbgopts_t_debmod_get, _ida_pro.
        instant_dbgopts_t_debmod_set)
    """name of debugger module
"""
    env: str = property(_ida_pro.instant_dbgopts_t_env_get, _ida_pro.
        instant_dbgopts_t_env_set)
    """config variables for debmod. example: DEFAULT_CPU=13;MAXPACKETSIZE=-1
"""
    host: str = property(_ida_pro.instant_dbgopts_t_host_get, _ida_pro.
        instant_dbgopts_t_host_set)
    """remote hostname (if remote debugging)
"""
    _pass: str = property(_ida_pro.instant_dbgopts_t__pass_get, _ida_pro.
...
"""
    attach: bool = property(_ida_pro.instant_dbgopts_t_attach_get, _ida_pro
