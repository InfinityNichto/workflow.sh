...
class segment_t(ida_range.range_t):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    name: int = property(_ida_segment.segment_t_name_get, _ida_segment.
        segment_t_name_set)
    """use get/set_segm_name() functions
"""
    sclass: int = property(_ida_segment.segment_t_sclass_get, _ida_segment.
        segment_t_sclass_set)
    """use get/set_segm_class() functions
"""
    orgbase: int = property(_ida_segment.segment_t_orgbase_get,
...
:returns: success"""
    ...
    start_ea: ida_idaapi.ea_t = property(_ida_segment.
        segment_t_start_ea_get, _ida_segment.segment_t_start_ea_set)
    end_ea: ida_idaapi.ea_t = property(_ida_segment.segment_t_end_ea_get,
