...
class strwinsetup_t(object):
    ...
    __repr__ = _swig_repr
    minlen: int = property(_ida_strlist.strwinsetup_t_minlen_get,
...
class string_info_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    ea: ida_idaapi.ea_t = property(_ida_strlist.string_info_t_ea_get,
        _ida_strlist.string_info_t_ea_set)
    length: int = property(_ida_strlist.string_info_t_length_get,
        _ida_strlist.string_info_t_length_set)
    type: int = property(_ida_strlist.string_info_t_type_get, _ida_strlist.
