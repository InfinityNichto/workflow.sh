...
class disasm_line_t(object):
    ...
    line: str = property(_ida_kernwin.disasm_line_t_line_get, _ida_kernwin.
...
def is_ida_library(path: 'char *'=None, pathsize: 'size_t'=0, handle:
    'void **'=None) ->bool:
...
:returns: true if the two places match / are equal."""
        return _ida_kernwin.place_t_equals(self, t2, ud)
...
def l_equals(t1: 'place_t', t2: 'place_t', ud: 'void *') ->bool:
    return _ida_kernwin.l_equals(t1, t2, ud)
...
class simpleline_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    line: str = property(_ida_kernwin.simpleline_t_line_get, _ida_kernwin.
...
class simpleline_place_t(place_t):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError('No constructor defined - class is abstract')
    __repr__ = _swig_repr
    n: int = property(_ida_kernwin.simpleline_place_t_n_get, _ida_kernwin.
...
class idaplace_t(place_t):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError('No constructor defined - class is abstract')
    __repr__ = _swig_repr
    ea: ida_idaapi.ea_t = property(_ida_kernwin.idaplace_t_ea_get,
        _ida_kernwin.idaplace_t_ea_set)
    """address
"""
...
class tiplace_t(place_t):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError('No constructor defined - class is abstract')
    __repr__ = _swig_repr
    ordinal: int = property(_ida_kernwin.tiplace_t_ordinal_get,
...
"""
    ...
    def __init__(self, t: 'place_t'=None, x0: int=0):
        _ida_kernwin.twinpos_t_swiginit(self, _ida_kernwin.new_twinpos_t(t, x0)
            )
...
class twinline_t(object):
    ...
    """location in view
"""
    line: str = property(_ida_kernwin.twinline_t_line_get, _ida_kernwin.
        twinline_t_line_set)
    """line contents
"""
    prefix_color: 'color_t' = property(_ida_kernwin.
...
that the number of lines for that particular place is only 2, then 3 will be returned."""
    ...
    def copy_from(self, src: 'linearray_t') ->None:
        ...
        """
        return _ida_kernwin.linearray_t_copy_from(self, src)
...
"""
    ...
    def set_max_lines(self, n: int) ->None:
        ...
        """
        return _ida_kernwin.linearray_t_set_max_lines(self, n)
...
class line_rendering_output_entry_t(object):
    ...
    flags: int = property(_ida_kernwin.
...
"""
    ...
    cpx: int = property(_ida_kernwin.line_rendering_output_entry_t_cpx_get,
        _ida_kernwin.line_rendering_output_entry_t_cpx_set)
...
class lines_rendering_output_t(object):
    ...
    flags: int = property(_ida_kernwin.lines_rendering_output_t_flags_get,
        _ida_kernwin.lines_rendering_output_t_flags_set)
...
class listing_location_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    cb: int = property(_ida_kernwin.listing_location_t_cb_get, _ida_kernwin
        .listing_location_t_cb_set)
    loc: 'lochist_entry_t const *' = property(_ida_kernwin.
        listing_location_t_loc_get, _ida_kernwin.listing_location_t_loc_set)
    text: str = property(_ida_kernwin.listing_location_t_text_get,
        _ida_kernwin.listing_location_t_text_set)
...
"""
BWN_TYPE_EDITOR = _ida_kernwin.BWN_TYPE_EDITOR
"""a type editor
"""
BWN_MICROCODE = _ida_kernwin.BWN_MICROCODE
"""microcode view (part of hexrays decompiler)
"""
BWN_XREF_TREE = _ida_kernwin.BWN_XREF_TREE
"""xref tree widget
"""
...
"""
IWID_TYPE_EDITOR = _ida_kernwin.IWID_TYPE_EDITOR
"""a type editor
"""
IWID_XREF_TREE = _ida_kernwin.IWID_XREF_TREE
"""xref tree widget
"""
...
class chooser_stdact_desc_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    version: int = property(_ida_kernwin.chooser_stdact_desc_t_version_get,
        _ida_kernwin.chooser_stdact_desc_t_version_set)
    """to support the backward compatibility
"""
    label: str = property(_ida_kernwin.chooser_stdact_desc_t_label_get,
        _ida_kernwin.chooser_stdact_desc_t_label_set)
    """see action_desc_t
"""
    tooltip: str = property(_ida_kernwin.chooser_stdact_desc_t_tooltip_get,
        _ida_kernwin.chooser_stdact_desc_t_tooltip_set)
...
"""
    ...
    """(in chars)
"""
    title: str = property(_ida_kernwin.chooser_base_t_title_get)
...
class view_mouse_event_location_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    ea: ida_idaapi.ea_t = property(_ida_kernwin.
        view_mouse_event_location_t_ea_get, _ida_kernwin.
...
"""
    x: int = property(_ida_kernwin.view_mouse_event_t_x_get, _ida_kernwin.
        view_mouse_event_t_x_set)
    """screen x coordinate
"""
    y: int = property(_ida_kernwin.view_mouse_event_t_y_get, _ida_kernwin.
...
class input_event_shortcut_data_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    action_name: str = property(_ida_kernwin.
...
"""
    widget_title: str = property(_ida_kernwin.
...
"""
    action: str = property(_ida_kernwin.action_ctx_base_t_action_get,
        _ida_kernwin.action_ctx_base_t_action_set)
    """action name
"""
    cur_flags: int = property(_ida_kernwin.action_ctx_base_t_cur_flags_get,
        _ida_kernwin.action_ctx_base_t_cur_flags_set)
...
"""
    ...
    cur_ea: ida_idaapi.ea_t = property(_ida_kernwin.
        action_ctx_base_t_cur_ea_get, _ida_kernwin.action_ctx_base_t_cur_ea_set
        )
    """the current EA of the position in the view
"""
    cur_value: int = property(_ida_kernwin.action_ctx_base_t_cur_value_get,
        _ida_kernwin.action_ctx_base_t_cur_value_set)
...
"""
    regname: str = property(_ida_kernwin.action_ctx_base_t_regname_get,
        _ida_kernwin.action_ctx_base_t_regname_set)
...
"""
    name: str = property(_ida_kernwin.action_desc_t_name_get, _ida_kernwin.
    ...
    """the internal name of the action; must be unique. a way to reduce possible conflicts is to prefix it with some specific prefix. E.g., "myplugin:doSthg". 
        """
    label: str = property(_ida_kernwin.action_desc_t_label_get,
    ...
    """either the plugin_t, or plugmod_t responsible for registering the action. Can be nullptr Please see ACTION_DESC_LITERAL_PLUGMOD 
        """
    shortcut: str = property(_ida_kernwin.action_desc_t_shortcut_get,
        _ida_kernwin.action_desc_t_shortcut_set)
    """an optional shortcut definition. E.g., "Ctrl+Enter\"
"""
    tooltip: str = property(_ida_kernwin.action_desc_t_tooltip_get,
        _ida_kernwin.action_desc_t_tooltip_set)
    """an optional tooltip for the action
"""
    icon: int = property(_ida_kernwin.action_desc_t_icon_get, _ida_kernwin.
...
class addon_info_t(object):
    ...
    cb: 'size_t' = property(_ida_kernwin.addon_info_t_cb_get, _ida_kernwin.
        addon_info_t_cb_set)
    id: str = property(_ida_kernwin.addon_info_t_id_get, _ida_kernwin.
        addon_info_t_id_set)
    name: str = property(_ida_kernwin.addon_info_t_name_get, _ida_kernwin.
        addon_info_t_name_set)
    producer: str = property(_ida_kernwin.addon_info_t_producer_get,
        _ida_kernwin.addon_info_t_producer_set)
    version: str = property(_ida_kernwin.addon_info_t_version_get,
        _ida_kernwin.addon_info_t_version_set)
    url: str = property(_ida_kernwin.addon_info_t_url_get, _ida_kernwin.
        addon_info_t_url_set)
    freeform: str = property(_ida_kernwin.addon_info_t_freeform_get,
        _ida_kernwin.addon_info_t_freeform_set)
...
class strarray_t(object):
    ...
    code: int = property(_ida_kernwin.strarray_t_code_get, _ida_kernwin.
        strarray_t_code_set)
    text: str = property(_ida_kernwin.strarray_t_text_get, _ida_kernwin.
        strarray_t_text_set)
...
def ask_addr(defval: ida_idaapi.ea_t, prompt: str) ->Union[ida_idaapi.ea_t,
    None]:
...
"""
    ...
    def _ensure_widget_deps(ctx):
        for modname in ['shiboken6.Shiboken', 'PySide6.QtWidgets']:
            if not hasattr(ctx, modname):
                import importlib
                setattr(ctx, modname, importlib.import_module(modname))
    ...
    def TWidgetToQtPythonWidget(tw, ctx=sys.modules['__main__']):
        ...
        metaObject = shiboken6.Shiboken.wrapInstance(ptr_l, PySide6.
            QtWidgets.QWidget).metaObject()
        known_type = PySide6.QtWidgets.QWidget
        while metaObject:
            try:
                known_type = getattr(PySide6.QtWidgets, metaObject.className())
                break
            except AttributeError:
                metaObject = metaObject.superClass()
        return shiboken6.Shiboken.wrapInstance(ptr_l, known_type)
    ...
    def QtWidgetToTWidget(w, ctx=sys.modules['__main__']):
        ...
        import shiboken6.Shiboken
        result = shiboken6.Shiboken.getCppPointer(w)
