...
| Source code                   | Keywords   | Level                              |
|-------------------------------|------------|------------------------------------|
| [custom_calling_convention.py](https://github.com/HexRaysSA/IDAPython/tree/<insert-branch-here>/examples/types/custom_calling_convention.py) | types | Intermediate |
