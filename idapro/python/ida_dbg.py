...
class bpt_location_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    info: ida_idaapi.ea_t = property(_ida_dbg.bpt_location_t_info_get,
        _ida_dbg.bpt_location_t_info_set)
...
"""
    ea: ida_idaapi.ea_t = property(_ida_dbg.bpt_t_ea_get, _ida_dbg.bpt_t_ea_set
        )
...
"""
    ...
    """Number of times the breakpoint is hit before stopping (default is 0: stop always) 
        """
    flags: int = property(_ida_dbg.bpt_t_flags_get, _ida_dbg.bpt_t_flags_set)
    """Breakpoint property bits 
        """
    props: int = property(_ida_dbg.bpt_t_props_get, _ida_dbg.bpt_t_props_set)
...
"""
    cndidx: int = property(_ida_dbg.bpt_t_cndidx_get, _ida_dbg.bpt_t_cndidx_set
        )
...
"""
    ea: ida_idaapi.ea_t = property(_ida_dbg.tev_info_t_ea_get, _ida_dbg.
        tev_info_t_ea_set)
...
class memreg_info_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    ea: ida_idaapi.ea_t = property(_ida_dbg.memreg_info_t_ea_get, _ida_dbg.
...
class tev_reg_value_t(object):
    ...
    reg_idx: int = property(_ida_dbg.tev_reg_value_t_reg_idx_get, _ida_dbg.
        tev_reg_value_t_reg_idx_set)
...
class eval_ctx_t(object):
    ...
    ea: ida_idaapi.ea_t = property(_ida_dbg.eval_ctx_t_ea_get, _ida_dbg.
        eval_ctx_t_ea_set)
