...
class direntry_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    idx: int = property(_ida_dirtree.direntry_t_idx_get, _ida_dirtree.
        direntry_t_idx_set)
    """diridx_t or inode_t
"""
    isdir: bool = property(_ida_dirtree.direntry_t_isdir_get, _ida_dirtree.
        direntry_t_isdir_set)
...
class dirspec_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    flags: int = property(_ida_dirtree.dirspec_t_flags_get, _ida_dirtree.
        dirspec_t_flags_set)
    ...
    id: str = property(_ida_dirtree.dirspec_t_id_get, _ida_dirtree.
        dirspec_t_id_set)
...
class dirtree_iterator_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    pattern: str = property(_ida_dirtree.dirtree_iterator_t_pattern_get,
        _ida_dirtree.dirtree_iterator_t_pattern_set)
