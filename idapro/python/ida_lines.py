...
GDISMF_REMOVE_TAGS = _ida_lines.GDISMF_REMOVE_TAGS
GDISMF_UNHIDE = _ida_lines.GDISMF_UNHIDE
...
GENDSM_UNHIDE = _ida_lines.GENDSM_UNHIDE
...
def generate_disassembly(ea, max_lines, as_stack, notag, include_hidden:
    Boolean=False):
...
:returns: None on failure"""
    return _ida_lines.generate_disassembly(ea, max_lines, as_stack, notag,
        include_hidden)
