...
class loader_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    version: int = property(_ida_loader.loader_t_version_get, _ida_loader.
        loader_t_version_set)
    """api version, should be IDP_INTERFACE_VERSION
"""
    flags: int = property(_ida_loader.loader_t_flags_get, _ida_loader.
        loader_t_flags_set)
    """Loader flags 
        """
...
class idp_name_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    lname: str = property(_ida_loader.idp_name_t_lname_get, _ida_loader.
        idp_name_t_lname_set)
    """long processor name
"""
    sname: str = property(_ida_loader.idp_name_t_sname_get, _ida_loader.
        idp_name_t_sname_set)
    """short processor name
"""
    hidden: bool = property(_ida_loader.idp_name_t_hidden_get, _ida_loader.
...
class idp_desc_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    path: str = property(_ida_loader.idp_desc_t_path_get, _ida_loader.
        idp_desc_t_path_set)
    """module file name
"""
...
"""
    family: str = property(_ida_loader.idp_desc_t_family_get, _ida_loader.
...
"""
    ...
    flags: int = property(_ida_loader.plugin_info_t_flags_get, _ida_loader.
...
"""
    idaplg_name: str = property(_ida_loader.plugin_info_t_idaplg_name_get,
        _ida_loader.plugin_info_t_idaplg_name_set)
