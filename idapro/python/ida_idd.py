...
class process_info_t(object):
    ...
    """process id
"""
    name: str = property(_ida_idd.process_info_t_name_get, _ida_idd.
...
class debapp_attrs_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    cbsize: int = property(_ida_idd.debapp_attrs_t_cbsize_get, _ida_idd.
        debapp_attrs_t_cbsize_set)
    """control field: size of this structure
"""
    addrsize: int = property(_ida_idd.debapp_attrs_t_addrsize_get, _ida_idd
    ...
    """address size of the process. Since 64-bit debuggers usually can debug 32-bit applications, we cannot rely on sizeof(ea_t) to detect the current address size. The following variable should be used instead. It is initialized with 8 for 64-bit debuggers but they should adjust it as soon as they learn that a 32-bit application is being debugged. For 32-bit debuggers it is initialized with 4. 
        """
    platform: str = property(_ida_idd.debapp_attrs_t_platform_get, _ida_idd
...
class register_info_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    name: str = property(_ida_idd.register_info_t_name_get, _ida_idd.
        register_info_t_name_set)
    """Register name.
"""
    flags: int = property(_ida_idd.register_info_t_flags_get, _ida_idd.
        register_info_t_flags_set)
    """Register info attribute flags 
        """
    register_class_mask: 'uchar' = property(_ida_idd.
        register_info_t_register_class_mask_get, _ida_idd.
        register_info_t_register_class_mask_set)
...
"""
    default_bit_strings_mask: int = property(_ida_idd.
...
"""
    ...
    """strings corresponding to each bit of the register. (nullptr = no bit, same name = multi-bits mask) 
        """
    register_class = register_class_mask
...
class memory_info_t(ida_range.range_t):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    name: str = property(_ida_idd.memory_info_t_name_get, _ida_idd.
        memory_info_t_name_set)
    """Memory range name.
"""
    sclass: str = property(_ida_idd.memory_info_t_sclass_get, _ida_idd.
        memory_info_t_sclass_set)
    """Memory range class name.
"""
    sbase: ida_idaapi.ea_t = property(_ida_idd.memory_info_t_sbase_get,
        _ida_idd.memory_info_t_sbase_set)
...
class scattered_segm_t(ida_range.range_t):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    name: str = property(_ida_idd.scattered_segm_t_name_get, _ida_idd.
...
class modinfo_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    name: str = property(_ida_idd.modinfo_t_name_get, _ida_idd.
        modinfo_t_name_set)
    """full name of the module
"""
    base: ida_idaapi.ea_t = property(_ida_idd.modinfo_t_base_get, _ida_idd.
        modinfo_t_base_set)
...
"""
    rebase_to: ida_idaapi.ea_t = property(_ida_idd.modinfo_t_rebase_to_get,
        _ida_idd.modinfo_t_rebase_to_set)
...
class bptaddr_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    hea: ida_idaapi.ea_t = property(_ida_idd.bptaddr_t_hea_get, _ida_idd.
        bptaddr_t_hea_set)
    """Possible address referenced by hardware breakpoints.
"""
    kea: ida_idaapi.ea_t = property(_ida_idd.bptaddr_t_kea_get, _ida_idd.
        bptaddr_t_kea_set)
...
class excinfo_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    code: int = property(_ida_idd.excinfo_t_code_get, _ida_idd.
        excinfo_t_code_set)
    """Exception code.
"""
...
"""
    ea: ida_idaapi.ea_t = property(_ida_idd.excinfo_t_ea_get, _ida_idd.
        excinfo_t_ea_set)
    """Possible address referenced by the exception.
"""
    info: str = property(_ida_idd.excinfo_t_info_get, _ida_idd.
        excinfo_t_info_set)
    """Exception message.
"""
...
"""
    ea: ida_idaapi.ea_t = property(_ida_idd.debug_event_t_ea_get, _ida_idd.
...
class exception_info_t(object):
    ...
    """exception code
"""
    flags: int = property(_ida_idd.exception_info_t_flags_get, _ida_idd.
...
"""
    ...
    name: str = property(_ida_idd.exception_info_t_name_get, _ida_idd.
        exception_info_t_name_set)
    """Exception standard name.
"""
    desc: str = property(_ida_idd.exception_info_t_desc_get, _ida_idd.
...
class regval_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    rvtype: int = property(_ida_idd.regval_t_rvtype_get, _ida_idd.
        regval_t_rvtype_set)
...
class call_stack_info_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    callea: ida_idaapi.ea_t = property(_ida_idd.
        call_stack_info_t_callea_get, _ida_idd.call_stack_info_t_callea_set)
    """the address of the call instruction. for the 0th frame this is usually just the current value of EIP. 
        """
    funcea: ida_idaapi.ea_t = property(_ida_idd.
        call_stack_info_t_funcea_get, _ida_idd.call_stack_info_t_funcea_set)
    """the address of the called function
"""
    fp: ida_idaapi.ea_t = property(_ida_idd.call_stack_info_t_fp_get,
        _ida_idd.call_stack_info_t_fp_set)
    """the value of the frame pointer of the called function
"""
    funcok: bool = property(_ida_idd.call_stack_info_t_funcok_get, _ida_idd
...
class thread_name_t(object):
    ...
    """thread
"""
    name: str = property(_ida_idd.thread_name_t_name_get, _ida_idd.
...
class debugger_t(object):
    ...
    """Expected kernel version, should be IDD_INTERFACE_VERSION 
        """
    name: str = property(_ida_idd.debugger_t_name_get, _ida_idd.
        debugger_t_name_set)
...
"""
    processor: str = property(_ida_idd.debugger_t_processor_get, _ida_idd.
        debugger_t_processor_set)
