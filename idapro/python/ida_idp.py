...
class asm_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    flag: int = property(_ida_idp.asm_t_flag_get, _ida_idp.asm_t_flag_set)
    ...
    """user defined flags (local only for IDP) you may define and use your own bits 
        """
    name: str = property(_ida_idp.asm_t_name_get, _ida_idp.asm_t_name_set)
...
"""
    ...
    """array of automatically generated header lines they appear at the start of disassembled text 
        """
    origin: str = property(_ida_idp.asm_t_origin_get, _ida_idp.asm_t_origin_set
        )
    """org directive
"""
    end: str = property(_ida_idp.asm_t_end_get, _ida_idp.asm_t_end_set)
    """end directive
"""
    cmnt: str = property(_ida_idp.asm_t_cmnt_get, _ida_idp.asm_t_cmnt_set)
...
"""
    esccodes: str = property(_ida_idp.asm_t_esccodes_get, _ida_idp.
        asm_t_esccodes_set)
    """special chars that cannot appear as is in string and char literals 
        """
    a_ascii: str = property(_ida_idp.asm_t_a_ascii_get, _ida_idp.
        asm_t_a_ascii_set)
    """string literal directive
"""
    a_byte: str = property(_ida_idp.asm_t_a_byte_get, _ida_idp.asm_t_a_byte_set
        )
    """byte directive
"""
    a_word: str = property(_ida_idp.asm_t_a_word_get, _ida_idp.asm_t_a_word_set
        )
    """word directive
"""
    a_dword: str = property(_ida_idp.asm_t_a_dword_get, _ida_idp.
        asm_t_a_dword_set)
    """nullptr if not allowed
"""
    a_qword: str = property(_ida_idp.asm_t_a_qword_get, _ida_idp.
        asm_t_a_qword_set)
    """nullptr if not allowed
"""
    a_oword: str = property(_ida_idp.asm_t_a_oword_get, _ida_idp.
        asm_t_a_oword_set)
    """nullptr if not allowed
"""
    a_float: str = property(_ida_idp.asm_t_a_float_get, _ida_idp.
        asm_t_a_float_set)
    """float; 4bytes; nullptr if not allowed
"""
    a_double: str = property(_ida_idp.asm_t_a_double_get, _ida_idp.
        asm_t_a_double_set)
    """double; 8bytes; nullptr if not allowed
"""
    a_tbyte: str = property(_ida_idp.asm_t_a_tbyte_get, _ida_idp.
        asm_t_a_tbyte_set)
    """long double; nullptr if not allowed
"""
    a_packreal: str = property(_ida_idp.asm_t_a_packreal_get, _ida_idp.
        asm_t_a_packreal_set)
    """packed decimal real nullptr if not allowed
"""
    a_dups: str = property(_ida_idp.asm_t_a_dups_get, _ida_idp.asm_t_a_dups_set
        )
...
* #s(b,w,l,q,f,d,o) size specifiers for byte,word, dword,qword, float,double,oword 
        ...
        """
    a_bss: str = property(_ida_idp.asm_t_a_bss_get, _ida_idp.asm_t_a_bss_set)
    """uninitialized data directive should include 's' for the size of data 
        """
    a_equ: str = property(_ida_idp.asm_t_a_equ_get, _ida_idp.asm_t_a_equ_set)
    """'equ' Used if AS_UNEQU is set
"""
    a_seg: str = property(_ida_idp.asm_t_a_seg_get, _ida_idp.asm_t_a_seg_set)
    """'seg ' prefix (example: push seg seg001)
"""
    a_curip: str = property(_ida_idp.asm_t_a_curip_get, _ida_idp.
        asm_t_a_curip_set)
    """current IP (instruction pointer) symbol in assembler
"""
    a_public: str = property(_ida_idp.asm_t_a_public_get, _ida_idp.
        asm_t_a_public_set)
    """"public" name keyword. nullptr-use default, ""-do not generate
"""
    a_weak: str = property(_ida_idp.asm_t_a_weak_get, _ida_idp.asm_t_a_weak_set
        )
    """"weak" name keyword. nullptr-use default, ""-do not generate
"""
    a_extrn: str = property(_ida_idp.asm_t_a_extrn_get, _ida_idp.
        asm_t_a_extrn_set)
    """"extern" name keyword
"""
    a_comdef: str = property(_ida_idp.asm_t_a_comdef_get, _ida_idp.
        asm_t_a_comdef_set)
    """"comm" (communal variable)
"""
    a_align: str = property(_ida_idp.asm_t_a_align_get, _ida_idp.
        asm_t_a_align_set)
    """"align" keyword
"""
...
"""
    a_mod: str = property(_ida_idp.asm_t_a_mod_get, _ida_idp.asm_t_a_mod_set)
    """% mod assembler time operation
"""
    a_band: str = property(_ida_idp.asm_t_a_band_get, _ida_idp.asm_t_a_band_set
        )
    """& bit and assembler time operation
"""
    a_bor: str = property(_ida_idp.asm_t_a_bor_get, _ida_idp.asm_t_a_bor_set)
    """| bit or assembler time operation
"""
    a_xor: str = property(_ida_idp.asm_t_a_xor_get, _ida_idp.asm_t_a_xor_set)
    """^ bit xor assembler time operation
"""
    a_bnot: str = property(_ida_idp.asm_t_a_bnot_get, _ida_idp.asm_t_a_bnot_set
        )
    """~ bit not assembler time operation
"""
    a_shl: str = property(_ida_idp.asm_t_a_shl_get, _ida_idp.asm_t_a_shl_set)
    """<< shift left assembler time operation
"""
    a_shr: str = property(_ida_idp.asm_t_a_shr_get, _ida_idp.asm_t_a_shr_set)
    """>> shift right assembler time operation
"""
    a_sizeof_fmt: str = property(_ida_idp.asm_t_a_sizeof_fmt_get, _ida_idp.
        asm_t_a_sizeof_fmt_set)
    """size of type (format string)
"""
    flag2: int = property(_ida_idp.asm_t_flag2_get, _ida_idp.asm_t_flag2_set)
    """Secondary assembler feature bits 
        """
    cmnt2: str = property(_ida_idp.asm_t_cmnt2_get, _ida_idp.asm_t_cmnt2_set)
    """comment close string (usually nullptr) this is used to denote a string which closes comments, for example, if the comments are represented with (* ... *) then cmnt = "(*" and cmnt2 = "*)" 
        """
    low8: str = property(_ida_idp.asm_t_low8_get, _ida_idp.asm_t_low8_set)
    """low8 operation, should contain s for the operand
"""
    high8: str = property(_ida_idp.asm_t_high8_get, _ida_idp.asm_t_high8_set)
    """high8
"""
    low16: str = property(_ida_idp.asm_t_low16_get, _ida_idp.asm_t_low16_set)
    """low16
"""
    high16: str = property(_ida_idp.asm_t_high16_get, _ida_idp.asm_t_high16_set
        )
    """high16
"""
    a_include_fmt: str = property(_ida_idp.asm_t_a_include_fmt_get,
        _ida_idp.asm_t_a_include_fmt_set)
    """the include directive (format string)
"""
    a_vstruc_fmt: str = property(_ida_idp.asm_t_a_vstruc_fmt_get, _ida_idp.
    ...
    """if a named item is a structure and displayed in the verbose (multiline) form then display the name as printf(a_strucname_fmt, typename) (for asms with type checking, e.g. tasm ideal) 
        """
    a_rva: str = property(_ida_idp.asm_t_a_rva_get, _ida_idp.asm_t_a_rva_set)
    """'rva' keyword for image based offsets (see REFINFO_RVAOFF) 
        """
    a_yword: str = property(_ida_idp.asm_t_a_yword_get, _ida_idp.
        asm_t_a_yword_set)
    """32-byte (256-bit) data; nullptr if not allowed requires AS2_YWORD 
        """
    a_zword: str = property(_ida_idp.asm_t_a_zword_get, _ida_idp.
        asm_t_a_zword_set)
...
class _processor_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    version: int = property(_ida_idp._processor_t_version_get, _ida_idp.
    ...
    ev_is_addr_insn = _ida_idp._processor_t_ev_is_addr_insn
...
"""
    ...
    @staticmethod
    def is_addr_insn(type: 'int *', insn: 'insn_t const &') ->'ssize_t':
        return _ida_idp._processor_t_is_addr_insn(type, insn)
...
"""
    ...
    @staticmethod
    def get_cc_regs(regs: 'callregs_t', cc: 'callcnv_t') ->'ssize_t':
...
local_type_renamed = _ida_idp.local_type_renamed
...
:returns: 0: not implemented"""
    ...
    def ev_is_addr_insn(self, type: 'int *', insn: 'insn_t const *') ->int:
...
:returns: 0: not implemented"""
        return _ida_idp.IDP_Hooks_ev_is_addr_insn(self, type, insn)
...
:returns: 0: not implemented"""
    ...
    def ev_calc_retloc(self, retloc: 'argloc_t', rettype: 'tinfo_t', cc:
        'callcnv_t') ->int:
...
:returns: 0: not implemented or failed"""
    ...
    def ev_get_stkarg_area_info(self, out: 'stkarg_area_info_t', cc:
        'callcnv_t') ->int:
...
:param edmnew: (::const edm_t *)"""
    ...
    def local_type_renamed(self, ordinal: int, oldname: str, newname: str
        ) ->None:
...
:param newname: (const char *) nullptr means name is unknown"""
        return _ida_idp.IDB_Hooks_local_type_renamed(self, ordinal, oldname,
            newname)
