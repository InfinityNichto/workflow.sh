...
class try_handler_t(ida_range.rangevec_t):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    disp: int = property(_ida_tryblks.try_handler_t_disp_get, _ida_tryblks.
...
class seh_t(try_handler_t):
    ...
    seh_code: ida_idaapi.ea_t = property(_ida_tryblks.seh_t_seh_code_get,
...
class catch_t(try_handler_t):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    obj: int = property(_ida_tryblks.catch_t_obj_get, _ida_tryblks.
        catch_t_obj_set)
    type_id: int = property(_ida_tryblks.catch_t_type_id_get, _ida_tryblks.
        catch_t_type_id_set)
