...
class range_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    start_ea: ida_idaapi.ea_t = property(_ida_range.range_t_start_ea_get,
        _ida_range.range_t_start_ea_set)
    """start_ea included
"""
    end_ea: ida_idaapi.ea_t = property(_ida_range.range_t_end_ea_get,
        _ida_range.range_t_end_ea_set)
    """end_ea excluded
"""
...
"""
        return _ida_range.rangeset_t_as_rangevec(self)
