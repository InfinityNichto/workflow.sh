...
class QAbstractItemView(PySide6.QtWidgets.QAbstractScrollArea):
    ...
    def openEditor(self, index: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, event: PySide6.QtCore.QEvent, /) -> None: ...
...
class QApplication(PySide6.QtGui.QGuiApplication):
    ...
    @typing.overload
    def __init__(self, arguments: typing.Sequence[str], /, *, cursorFlashTime: int | None= ..., doubleClickInterval: int | None= ..., keyboardInputInterval: int | None= ..., wheelScrollLines: int | None= ..., startDragTime: int | None= ..., startDragDistance: int | None= ..., styleSheet: str | None= ..., autoSipEnabled: bool | None= ...) -> None: ...
    @typing.overload
...
class QCompleter(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, completions: typing.Sequence[str], /, parent: PySide6.QtCore.QObject | None= ..., *, completionPrefix: str | None= ..., modelSorting: PySide6.QtWidgets.QCompleter.ModelSorting | None= ..., filterMode: PySide6.QtCore.Qt.MatchFlag | None= ..., completionMode: PySide6.QtWidgets.QCompleter.CompletionMode | None= ..., completionColumn: int | None= ..., completionRole: int | None= ..., maxVisibleItems: int | None= ..., caseSensitivity: PySide6.QtCore.Qt.CaseSensitivity | None= ..., wrapAround: bool | None= ...) -> None: ...
    @typing.overload
...
class QFileDialog(PySide6.QtWidgets.QDialog):
    ...
    @typing.overload
    def __init__(self, parent: PySide6.QtWidgets.QWidget, f: PySide6.QtCore.Qt.WindowType, /, *, viewMode: PySide6.QtWidgets.QFileDialog.ViewMode | None= ..., fileMode: PySide6.QtWidgets.QFileDialog.FileMode | None= ..., acceptMode: PySide6.QtWidgets.QFileDialog.AcceptMode | None= ..., defaultSuffix: str | None= ..., options: PySide6.QtGui.QAbstractFileIconProvider.Option | None= ..., supportedSchemes: typing.Sequence[str] | None= ...) -> None: ...
    @typing.overload
    def __init__(self, /, parent: PySide6.QtWidgets.QWidget | None= ..., caption: str = ..., directory: str = ..., filter: str = ..., *, viewMode: PySide6.QtWidgets.QFileDialog.ViewMode | None= ..., fileMode: PySide6.QtWidgets.QFileDialog.FileMode | None= ..., acceptMode: PySide6.QtWidgets.QFileDialog.AcceptMode | None= ..., defaultSuffix: str | None= ..., options: PySide6.QtGui.QAbstractFileIconProvider.Option | None= ..., supportedSchemes: typing.Sequence[str] | None= ...) -> None: ...
...
class QFontDialog(PySide6.QtWidgets.QDialog):
    ...
    @typing.overload
    def __init__(self, initial: PySide6.QtGui.QFont | str | typing.Sequence[str], /, parent: PySide6.QtWidgets.QWidget | None= ..., *, currentFont: PySide6.QtGui.QFont | None= ..., options: PySide6.QtWidgets.QFontDialog.FontDialogOption | None= ...) -> None: ...
...
class QInputDialog(PySide6.QtWidgets.QDialog):
    ...
    @staticmethod
    def getItem(parent: PySide6.QtWidgets.QWidget, title: str, label: str, items: typing.Sequence[str], /, current: int | None= ..., editable: bool = ..., flags: PySide6.QtCore.Qt.WindowType = ..., inputMethodHints: PySide6.QtCore.Qt.InputMethodHint = ...) -> typing.Tuple[str, bool]: ...
    @staticmethod
...
class QKeySequenceEdit(PySide6.QtWidgets.QWidget):
    ...
    @typing.overload
    def __init__(self, keySequence: PySide6.QtGui.QKeySequence, /, parent: PySide6.QtWidgets.QWidget | None= ..., *, clearButtonEnabled: bool | None= ..., maximumSequenceLength: int | None= ..., finishingKeyCombinations: typing.Sequence[PySide6.QtCore.QKeyCombination] | None= ...) -> None: ...
    @typing.overload
    def __init__(self, /, parent: PySide6.QtWidgets.QWidget | None= ..., *, keySequence: PySide6.QtGui.QKeySequence | None= ..., clearButtonEnabled: bool | None= ..., maximumSequenceLength: int | None= ..., finishingKeyCombinations: typing.Sequence[PySide6.QtCore.QKeyCombination] | None= ...) -> None: ...
...
class QTextBrowser(PySide6.QtWidgets.QTextEdit):
    ...
    def __init__(self, /, parent: PySide6.QtWidgets.QWidget | None= ..., *, source: PySide6.QtCore.QUrl | None= ..., sourceType: PySide6.QtGui.QTextDocument.ResourceType | None= ..., searchPaths: typing.Sequence[str] | None= ..., openExternalLinks: bool | None= ..., openLinks: bool | None= ...) -> None: ...
