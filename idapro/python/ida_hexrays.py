...
class cfuncptr_t(object):
    ...
    entry_ea: ida_idaapi.ea_t = property(_ida_hexrays.
        cfuncptr_t_entry_ea_get, _ida_hexrays.cfuncptr_t_entry_ea_set)
    ...
    refcnt: int = property(_ida_hexrays.cfuncptr_t_refcnt_get, _ida_hexrays
    ...
    def recalc_item_addresses(self) ->None:
        return _ida_hexrays.cfuncptr_t_recalc_item_addresses(self)
...
:returns: Microcode error code"""
        return _ida_hexrays.Hexrays_Hooks_mba_maturity(self, mba, reqmat)
...
"""cloud: s
"""
MERR_EMULATOR = _ida_hexrays.MERR_EMULATOR
"""emulator: s
"""
...
class operand_locator_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    ea: ida_idaapi.ea_t = property(_ida_hexrays.operand_locator_t_ea_get,
...
"""
    type_name: str = property(_ida_hexrays.number_format_t_type_name_get,
        _ida_hexrays.number_format_t_type_name_set)
...
class vd_printer_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    tmpbuf: str = property(_ida_hexrays.vd_printer_t_tmpbuf_get,
...
class qstring_printer_t(vc_printer_t):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    with_tags: bool = property(_ida_hexrays.qstring_printer_t_with_tags_get,
        _ida_hexrays.qstring_printer_t_with_tags_set)
    """Generate output with color tags.
"""
    s: str = property(_ida_hexrays.qstring_printer_t_s_get, _ida_hexrays.
...
class lvar_locator_t(object):
    ...
    """Variable location.
"""
    defea: ida_idaapi.ea_t = property(_ida_hexrays.lvar_locator_t_defea_get,
...
class lvar_t(lvar_locator_t):
    ...
    __repr__ = _swig_repr
    name: str = property(_ida_hexrays.lvar_t_name_get, _ida_hexrays.
        lvar_t_name_set)
    """variable name. use mba_t::set_nice_lvar_name() and mba_t::set_user_lvar_name() to modify it 
        """
    cmt: str = property(_ida_hexrays.lvar_t_cmt_get, _ida_hexrays.
        lvar_t_cmt_set)
...
class lvar_saved_info_t(object):
    ...
    """Variable locator.
"""
    name: str = property(_ida_hexrays.lvar_saved_info_t_name_get,
...
"""
    ...
    """Type.
"""
    cmt: str = property(_ida_hexrays.lvar_saved_info_t_cmt_get,
...
"""
    stkoff_delta: int = property(_ida_hexrays.
...
class udcall_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    name: str = property(_ida_hexrays.udcall_t_name_get, _ida_hexrays.
        udcall_t_name_set)
...
class ivl_with_name_t(object):
    ...
    whole: str = property(_ida_hexrays.ivl_with_name_t_whole_get,
        _ida_hexrays.ivl_with_name_t_whole_set)
    part: str = property(_ida_hexrays.ivl_with_name_t_part_get,
...
class simple_graph_t(ida_gdl.gdl_graph_t):
    ...
    __repr__ = _swig_repr
    title: str = property(_ida_hexrays.simple_graph_t_title_get,
...
class lvar_ref_t(object):
    ...
    """Pointer to the parent mba_t object. Since we need to access the 'mba->vars' array in order to retrieve the referenced variable, we keep a pointer to mba_t here. Note: this means this class and consequently mop_t, minsn_t, mblock_t are specific to a mba_t object and cannot migrate between them. fortunately this is not something we need to do. second, lvar_ref_t's appear only after MMAT_LVARS. 
        """
    off: int = property(_ida_hexrays.lvar_ref_t_off_get, _ida_hexrays.
        lvar_ref_t_off_set)
...
class stkvar_ref_t(object):
    ...
    """Pointer to the parent mba_t object. We need it in order to retrieve the referenced stack variable. See notes for lvar_ref_t::mba. 
        """
    off: int = property(_ida_hexrays.stkvar_ref_t_off_get, _ida_hexrays.
        stkvar_ref_t_off_set)
...
class scif_t(vdloc_t):
    ...
    """Pointer to the parent mba_t object. Some operations may convert a scattered operand into something simpler, (a stack operand, for example). We will need to create stkvar_ref_t at that moment, this is why we need this pointer. See notes for lvar_ref_t::mba. 
        """
    name: str = property(_ida_hexrays.scif_t_name_get, _ida_hexrays.
        scif_t_name_set)
...
"""
    nbytes: int = property(_ida_hexrays.fnumber_t_nbytes_get, _ida_hexrays.
...
"""
    ...
    def set_for_abi(self) ->None:
        return _ida_hexrays.mop_t_set_for_abi(self)
    ...
    def is_for_abi(self) ->bool:
        return _ida_hexrays.mop_t_is_for_abi(self)
...
"""
        return _ida_hexrays.mop_t_is_glbvar(self)

    def is_stkvar(self) ->bool:
        """Is a stack variable?
"""
        return _ida_hexrays.mop_t_is_stkvar(self)
...
"""
        return _ida_hexrays.mop_t_is_mblock(self, *args)
...
"""
    ...
    @property
    def nnn(self):
        return self._get_nnn() if self.t == mop_n else None

    @nnn.setter
    def nnn(self, value):
        return self._ensure_cond(self.t == mop_n, 'self.t == mop_n'
            ) and self._ensure_no_obj(self._get_nnn(), 'nnn', True
            ) and self._acquire_ownership(value, True) and self._set_nnn(value)
    ...
    @property
    def d(self):
        return self._get_d() if self.t == mop_d else None

    @d.setter
    def d(self, value):
        return self._ensure_cond(self.t == mop_d, 'self.t == mop_d'
            ) and self._ensure_no_obj(self._get_d(), 'd', True
            ) and self._acquire_ownership(value, True) and self._set_d(value)
    ...
    @property
    def s(self):
        return self._get_s() if self.t == mop_S else None

    @s.setter
    def s(self, value):
        return self._ensure_cond(self.t == mop_S, 'self.t == mop_S'
            ) and self._ensure_no_obj(self._get_s(), 's', True
            ) and self._acquire_ownership(value, True) and self._set_s(value)
    ...
    @property
    def f(self):
        return self._get_f() if self.t == mop_f else None

    @f.setter
    def f(self, value):
        return self._ensure_cond(self.t == mop_f, 'self.t == mop_f'
            ) and self._ensure_no_obj(self._get_f(), 'f', True
            ) and self._acquire_ownership(value, True) and self._set_f(value)
    ...
    @property
    def l(self):
        return self._get_l() if self.t == mop_l else None

    @l.setter
    def l(self, value):
        return self._ensure_cond(self.t == mop_l, 'self.t == mop_l'
            ) and self._ensure_no_obj(self._get_l(), 'l', True
            ) and self._acquire_ownership(value, True) and self._set_l(value)
    ...
    @property
    def a(self):
        return self._get_a() if self.t == mop_a else None

    @a.setter
    def a(self, value):
        return self._ensure_cond(self.t == mop_a, 'self.t == mop_a'
            ) and self._ensure_no_obj(self._get_a(), 'a', True
            ) and self._acquire_ownership(value, True) and self._set_a(value)
    ...
    @property
    def c(self):
        return self._get_c() if self.t == mop_c else None

    @c.setter
    def c(self, value):
        return self._ensure_cond(self.t == mop_c, 'self.t == mop_c'
            ) and self._ensure_no_obj(self._get_c(), 'c', True
            ) and self._acquire_ownership(value, True) and self._set_c(value)
    ...
    @property
    def fpc(self):
        return self._get_fpc() if self.t == mop_fn else None

    @fpc.setter
    def fpc(self, value):
        return self._ensure_cond(self.t == mop_fn, 'self.t == mop_fn'
            ) and self._ensure_no_obj(self._get_fpc(), 'fpc', True
            ) and self._acquire_ownership(value, True) and self._set_fpc(value)
    ...
    @property
    def pair(self):
        return self._get_pair() if self.t == mop_p else None

    @pair.setter
    def pair(self, value):
        return self._ensure_cond(self.t == mop_p, 'self.t == mop_p'
            ) and self._ensure_no_obj(self._get_pair(), 'pair', True
            ) and self._acquire_ownership(value, True) and self._set_pair(value
            )
    ...
    @property
    def scif(self):
        return self._get_scif() if self.t == mop_sc else None

    @scif.setter
    def scif(self, value):
        return self._ensure_cond(self.t == mop_sc, 'self.t == mop_sc'
            ) and self._ensure_no_obj(self._get_scif(), 'scif', True
            ) and self._acquire_ownership(value, True) and self._set_scif(value
            )
    ...
    @property
    def r(self):
        return self._get_r() if self.t == mop_r else None

    @r.setter
    def r(self, value):
        return self._ensure_cond(self.t == mop_r, 'self.t == mop_r'
            ) and self._set_r(value)
    ...
    @property
    def g(self):
        return self._get_g() if self.t == mop_v else None

    @g.setter
    def g(self, value):
        return self._ensure_cond(self.t == mop_v, 'self.t == mop_v'
            ) and self._set_g(value)
    ...
    @property
    def b(self):
        return self._get_b() if self.t == mop_b else None

    @b.setter
    def b(self, value):
        return self._ensure_cond(self.t == mop_b, 'self.t == mop_b'
            ) and self._set_b(value)
    ...
    @property
    def cstr(self):
        return self._get_cstr() if self.t == mop_str else None

    @cstr.setter
    def cstr(self, value):
        return self._ensure_cond(self.t == mop_str, 'self.t == mop_str'
            ) and self._ensure_no_obj(self._get_cstr(), 'cstr', False
            ) and self._acquire_ownership(value, False) and self._set_cstr(
            value)
    ...
    @property
    def helper(self):
        return self._get_helper() if self.t == mop_h else None

    @helper.setter
    def helper(self, value):
        return self._ensure_cond(self.t == mop_h, 'self.t == mop_h'
            ) and self._ensure_no_obj(self._get_helper(), 'helper', False
            ) and self._acquire_ownership(value, False) and self._set_helper(
            value)
...
"""
OPROP_ABI = _ida_hexrays.OPROP_ABI
...
class mop_addr_t(mop_t):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    insize: int = property(_ida_hexrays.mop_addr_t_insize_get, _ida_hexrays
        .mop_addr_t_insize_set)
...
class mcallarg_t(mop_t):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    ea: ida_idaapi.ea_t = property(_ida_hexrays.mcallarg_t_ea_get,
        _ida_hexrays.mcallarg_t_ea_set)
...
"""
    name: str = property(_ida_hexrays.mcallarg_t_name_get, _ida_hexrays.
        mcallarg_t_name_set)
...
"""
    ...
    """ida argloc
"""
    flags: int = property(_ida_hexrays.mcallarg_t_flags_get, _ida_hexrays.
        mcallarg_t_flags_set)
    """FAI_...
"""
...
class mcallinfo_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    callee: ida_idaapi.ea_t = property(_ida_hexrays.mcallinfo_t_callee_get,
...
"""
    cc: 'callcnv_t' = property(_ida_hexrays.mcallinfo_t_cc_get,
        _ida_hexrays.mcallinfo_t_cc_set)
    """calling convention
"""
...
* retregs.clear() since the call is propagated 
        ...
        """
    flags: int = property(_ida_hexrays.mcallinfo_t_flags_get, _ida_hexrays.
        mcallinfo_t_flags_set)
...
class voff_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    off: int = property(_ida_hexrays.voff_t_off_get, _ida_hexrays.
        voff_t_off_set)
...
"""
    ea: ida_idaapi.ea_t = property(_ida_hexrays.minsn_t_ea_get,
        _ida_hexrays.minsn_t_ea_set)
    """instruction address
"""
...
class intval64_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    val: 'uint64' = property(_ida_hexrays.intval64_t_val_get, _ida_hexrays.
        intval64_t_val_set)
    size: int = property(_ida_hexrays.intval64_t_size_get, _ida_hexrays.
        intval64_t_size_set)

    def __init__(self, v: 'uint64'=0, _s: int=1):
        _ida_hexrays.intval64_t_swiginit(self, _ida_hexrays.new_intval64_t(
            v, _s))

    def sval(self) ->'int64':
        return _ida_hexrays.intval64_t_sval(self)

    def uval(self) ->'uint64':
        return _ida_hexrays.intval64_t_uval(self)

    def _print(self) ->None:
        return _ida_hexrays.intval64_t__print(self)

    def __eq__(self, o: 'intval64_t') ->bool:
        return _ida_hexrays.intval64_t___eq__(self, o)

    def __ne__(self, o: 'intval64_t') ->bool:
        return _ida_hexrays.intval64_t___ne__(self, o)

    def __lt__(self, o: 'intval64_t') ->bool:
        return _ida_hexrays.intval64_t___lt__(self, o)

    def sext(self, target_sz: int) ->'intval64_t':
        return _ida_hexrays.intval64_t_sext(self, target_sz)

    def zext(self, target_sz: int) ->'intval64_t':
        return _ida_hexrays.intval64_t_zext(self, target_sz)

    def low(self, target_sz: int) ->'intval64_t':
        return _ida_hexrays.intval64_t_low(self, target_sz)

    def high(self, target_sz: int) ->'intval64_t':
        return _ida_hexrays.intval64_t_high(self, target_sz)

    def __add__(self, o: 'intval64_t') ->'intval64_t':
        return _ida_hexrays.intval64_t___add__(self, o)

    def __sub__(self, o: 'intval64_t') ->'intval64_t':
        return _ida_hexrays.intval64_t___sub__(self, o)

    def __mul__(self, o: 'intval64_t') ->'intval64_t':
        return _ida_hexrays.intval64_t___mul__(self, o)

    def __truediv__(self, *args):
        return _ida_hexrays.intval64_t___truediv__(self, *args)
    __div__ = __truediv__

    def sdiv(self, o: 'intval64_t') ->'intval64_t':
        return _ida_hexrays.intval64_t_sdiv(self, o)

    def __mod__(self, o: 'intval64_t') ->'intval64_t':
        return _ida_hexrays.intval64_t___mod__(self, o)

    def smod(self, o: 'intval64_t') ->'intval64_t':
        return _ida_hexrays.intval64_t_smod(self, o)

    def __lshift__(self, o: 'intval64_t') ->'intval64_t':
        return _ida_hexrays.intval64_t___lshift__(self, o)

    def __rshift__(self, o: 'intval64_t') ->'intval64_t':
        return _ida_hexrays.intval64_t___rshift__(self, o)

    def sar(self, o: 'intval64_t') ->'intval64_t':
        return _ida_hexrays.intval64_t_sar(self, o)

    def __or__(self, o: 'intval64_t') ->'intval64_t':
        return _ida_hexrays.intval64_t___or__(self, o)

    def __and__(self, o: 'intval64_t') ->'intval64_t':
        return _ida_hexrays.intval64_t___and__(self, o)

    def __xor__(self, o: 'intval64_t') ->'intval64_t':
        return _ida_hexrays.intval64_t___xor__(self, o)

    def __neg__(self) ->'intval64_t':
        return _ida_hexrays.intval64_t___neg__(self)

    def __invert__(self) ->'intval64_t':
        return _ida_hexrays.intval64_t___invert__(self)
    __swig_destroy__ = _ida_hexrays.delete_intval64_t


_ida_hexrays.intval64_t_swigregister(intval64_t)


class int64_emulator_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    __swig_destroy__ = _ida_hexrays.delete_int64_emulator_t

    def get_mop_value(self, mop: 'mop_t') ->'intval64_t':
        return _ida_hexrays.int64_emulator_t_get_mop_value(self, mop)

    def mop_value(self, mop: 'mop_t') ->'intval64_t':
        return _ida_hexrays.int64_emulator_t_mop_value(self, mop)

    def minsn_value(self, insn: 'minsn_t') ->'intval64_t':
        return _ida_hexrays.int64_emulator_t_minsn_value(self, insn)

    def __init__(self):
        if self.__class__ == int64_emulator_t:
            _self = None
        else:
            _self = self
        _ida_hexrays.int64_emulator_t_swiginit(self, _ida_hexrays.
            new_int64_emulator_t(_self))

    def __disown__(self):
        self.this.disown()
        _ida_hexrays.disown_int64_emulator_t(self)
        return weakref.proxy(self)


_ida_hexrays.int64_emulator_t_swigregister(int64_emulator_t)
...
"""
    flags: int = property(_ida_hexrays.mblock_t_flags_get, _ida_hexrays.
        mblock_t_flags_set)
    """combination of Basic block properties bits 
        """
    start: ida_idaapi.ea_t = property(_ida_hexrays.mblock_t_start_get,
        _ida_hexrays.mblock_t_start_set)
    """start address
"""
    end: ida_idaapi.ea_t = property(_ida_hexrays.mblock_t_end_get,
        _ida_hexrays.mblock_t_end_set)
...
"""
    maxbsp: int = property(_ida_hexrays.mblock_t_maxbsp_get, _ida_hexrays.
        mblock_t_maxbsp_set)
    """maximal sp value in the block (0...stacksize)
"""
    minbstkref: int = property(_ida_hexrays.mblock_t_minbstkref_get,
    ...
    """lowest stack location accessible with indirect addressing (offset from the stack bottom) initially it is 0 (not computed) 
        """
    minbargref: int = property(_ida_hexrays.mblock_t_minbargref_get,
...
"""
WARN_OPT_VALRNG4 = _ida_hexrays.WARN_OPT_VALRNG4
...
class hexwarn_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    ea: ida_idaapi.ea_t = property(_ida_hexrays.hexwarn_t_ea_get,
        _ida_hexrays.hexwarn_t_ea_set)
...
"""
    ...
    """Warning id.
"""
    text: str = property(_ida_hexrays.hexwarn_t_text_get, _ida_hexrays.
        hexwarn_t_text_set)
...
"""
    ...
    mbr: 'mba_ranges_t' = property(_ida_hexrays.mba_t_mbr_get, _ida_hexrays
        .mba_t_mbr_set)
    entry_ea: ida_idaapi.ea_t = property(_ida_hexrays.mba_t_entry_ea_get,
        _ida_hexrays.mba_t_entry_ea_set)
    last_prolog_ea: ida_idaapi.ea_t = property(_ida_hexrays.
        mba_t_last_prolog_ea_get, _ida_hexrays.mba_t_last_prolog_ea_set)
    first_epilog_ea: ida_idaapi.ea_t = property(_ida_hexrays.
        mba_t_first_epilog_ea_get, _ida_hexrays.mba_t_first_epilog_ea_set)
    qty: int = property(_ida_hexrays.mba_t_qty_get, _ida_hexrays.mba_t_qty_set)
...
"""
    ...
    """-1 - unknown
"""
    cc: 'callcnv_t' = property(_ida_hexrays.mba_t_cc_get, _ida_hexrays.
        mba_t_cc_set)
    """calling convention
"""
    tmpstk_size: int = property(_ida_hexrays.mba_t_tmpstk_size_get,
        _ida_hexrays.mba_t_tmpstk_size_set)
    """size of the temporary stack part (which dynamically changes with push/pops) 
        """
    frsize: int = property(_ida_hexrays.mba_t_frsize_get, _ida_hexrays.
        mba_t_frsize_set)
    """size of local stkvars range in the stack frame
"""
    frregs: int = property(_ida_hexrays.mba_t_frregs_get, _ida_hexrays.
        mba_t_frregs_set)
    """size of saved registers range in the stack frame
"""
    fpd: int = property(_ida_hexrays.mba_t_fpd_get, _ida_hexrays.mba_t_fpd_set)
    """frame pointer delta
"""
...
"""
    fullsize: int = property(_ida_hexrays.mba_t_fullsize_get, _ida_hexrays.
        mba_t_fullsize_set)
    """Full stack size including incoming args.
"""
    stacksize: int = property(_ida_hexrays.mba_t_stacksize_get,
    ...
    """The maximal size of the function stack including bytes allocated for outgoing call arguments (up to retaddr) 
        """
    inargoff: int = property(_ida_hexrays.mba_t_inargoff_get, _ida_hexrays.
        mba_t_inargoff_set)
    """offset of the first stack argument; after fix_scattered_movs() INARGOFF may be less than STACKSIZE 
        """
    minstkref: int = property(_ida_hexrays.mba_t_minstkref_get,
        _ida_hexrays.mba_t_minstkref_set)
    """The lowest stack location whose address was taken.
"""
    minstkref_ea: ida_idaapi.ea_t = property(_ida_hexrays.
        mba_t_minstkref_ea_get, _ida_hexrays.mba_t_minstkref_ea_set)
    """address with lowest minstkref (for debugging)
"""
    minargref: int = property(_ida_hexrays.mba_t_minargref_get,
    ...
    """The lowest stack argument location whose address was taken This location and locations above it can be aliased It controls locations >= inargoff-shadow_args 
        """
    spd_adjust: int = property(_ida_hexrays.mba_t_spd_adjust_get,
...
"""
    label: str = property(_ida_hexrays.mba_t_label_get, _ida_hexrays.
        mba_t_label_set)
...
"""
    ...
    """index of variable holding the return value -1 means none 
        """
    error_ea: ida_idaapi.ea_t = property(_ida_hexrays.mba_t_error_ea_get,
        _ida_hexrays.mba_t_error_ea_set)
    """during microcode generation holds ins.ea
"""
    error_strarg: str = property(_ida_hexrays.mba_t_error_strarg_get,
...
class cdg_insn_iterator_t(object):
    ...
    ea: ida_idaapi.ea_t = property(_ida_hexrays.cdg_insn_iterator_t_ea_get,
        _ida_hexrays.cdg_insn_iterator_t_ea_set)
    end: ida_idaapi.ea_t = property(_ida_hexrays.
        cdg_insn_iterator_t_end_get, _ida_hexrays.cdg_insn_iterator_t_end_set)
    dslot: ida_idaapi.ea_t = property(_ida_hexrays.
        cdg_insn_iterator_t_dslot_get, _ida_hexrays.
        cdg_insn_iterator_t_dslot_set)
    dslot_insn: 'insn_t' = property(_ida_hexrays.
        cdg_insn_iterator_t_dslot_insn_get, _ida_hexrays.
        cdg_insn_iterator_t_dslot_insn_set)
    severed_branch: ida_idaapi.ea_t = property(_ida_hexrays.
...
"""
    errea: ida_idaapi.ea_t = property(_ida_hexrays.
        hexrays_failure_t_errea_get, _ida_hexrays.hexrays_failure_t_errea_set)
    """associated address
"""
    str: str = property(_ida_hexrays.hexrays_failure_t_str_get,
...
class gco_info_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    name: str = property(_ida_hexrays.gco_info_t_name_get, _ida_hexrays.
        gco_info_t_name_set)
    """register or stkvar name
"""
    stkoff: int = property(_ida_hexrays.gco_info_t_stkoff_get, _ida_hexrays
        .gco_info_t_stkoff_set)
    """if stkvar, stack offset
"""
    regnum: int = property(_ida_hexrays.gco_info_t_regnum_get, _ida_hexrays
...
class treeloc_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    ea: ida_idaapi.ea_t = property(_ida_hexrays.treeloc_t_ea_get,
        _ida_hexrays.treeloc_t_ea_set)
...
class citem_locator_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    ea: ida_idaapi.ea_t = property(_ida_hexrays.citem_locator_t_ea_get,
        _ida_hexrays.citem_locator_t_ea_set)
    """citem address
"""
...
class citem_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    ea: ida_idaapi.ea_t = property(_ida_hexrays.citem_t_ea_get,
        _ida_hexrays.citem_t_ea_set)
...
"""
    exflags: int = property(_ida_hexrays.cexpr_t_exflags_get, _ida_hexrays.
        cexpr_t_exflags_set)
...
"""
    ...
    @property
    def n(self):
        return self._get_n() if self.op == cot_num else None

    @n.setter
    def n(self, value):
        return self._ensure_cond(self.op == cot_num, 'self.op == cot_num'
            ) and self._ensure_no_obj(self._get_n(), 'n', True
            ) and self._acquire_ownership(value, True) and self._set_n(value)
    ...
    @property
    def fpc(self):
        return self._get_fpc() if self.op == cot_fnum else None

    @fpc.setter
    def fpc(self, value):
        return self._ensure_cond(self.op == cot_fnum, 'self.op == cot_fnum'
            ) and self._ensure_no_obj(self._get_fpc(), 'fpc', True
            ) and self._acquire_ownership(value, True) and self._set_fpc(value)
    ...
    @property
    def x(self):
        return self._get_x() if op_uses_x(self.op) else None

    @x.setter
    def x(self, value):
        return self._ensure_cond(op_uses_x(self.op), 'op_uses_x(self.op)'
            ) and self._ensure_no_obj(self._get_x(), 'x', True
            ) and self._acquire_ownership(value, True) and self._set_x(value)
    ...
    @property
    def y(self):
        return self._get_y() if op_uses_y(self.op) else None

    @y.setter
    def y(self, value):
        return self._ensure_cond(op_uses_y(self.op), 'op_uses_y(self.op)'
            ) and self._ensure_no_obj(self._get_y(), 'y', True
            ) and self._acquire_ownership(value, True) and self._set_y(value)
    ...
    @property
    def z(self):
        return self._get_z() if op_uses_z(self.op) else None

    @z.setter
    def z(self, value):
        return self._ensure_cond(op_uses_z(self.op), 'op_uses_z(self.op)'
            ) and self._ensure_no_obj(self._get_z(), 'z', True
            ) and self._acquire_ownership(value, True) and self._set_z(value)
    ...
    @property
    def a(self):
        return self._get_a() if self.op == cot_call else None

    @a.setter
    def a(self, value):
        return self._ensure_cond(self.op == cot_call, 'self.op == cot_call'
            ) and self._ensure_no_obj(self._get_a(), 'a', True
            ) and self._acquire_ownership(value, True) and self._set_a(value)
    ...
    @property
    def insn(self):
        return self._get_insn() if self.op == cot_insn else None

    @insn.setter
    def insn(self, value):
        return self._ensure_cond(self.op == cot_insn, 'self.op == cot_insn'
            ) and self._ensure_no_obj(self._get_insn(), 'insn', True
            ) and self._acquire_ownership(value, True) and self._set_insn(value
            )
    ...
    def m(self):
        return self._get_m(
            ) if self.op == cot_memptr or self.op == cot_memref else 0

    @m.setter
    def m(self, value):
        return self._ensure_cond(self.op == cot_memptr or self.op ==
            cot_memref, 'self.op == cot_memptr or self.op == cot_memref'
            ) and self._set_m(value)
    ...
    @property
    def ptrsize(self):
        return self._get_ptrsize(
            ) if self.op == cot_ptr or self.op == cot_memptr else 0

    @ptrsize.setter
    def ptrsize(self, value):
        return self._ensure_cond(self.op == cot_ptr or self.op ==
            cot_memptr, 'self.op == cot_ptr or self.op == cot_memptr'
            ) and self._set_ptrsize(value)
    ...
    @property
    def obj_ea(self):
        return self._get_obj_ea() if self.op == cot_obj else ida_idaapi.BADADDR

    @obj_ea.setter
    def obj_ea(self, value):
        return self._ensure_cond(self.op == cot_obj, 'self.op == cot_obj'
            ) and self._set_obj_ea(value)
    ...
    @property
    def refwidth(self):
        return self._get_refwidth() if True else 0

    @refwidth.setter
    def refwidth(self, value):
        return self._ensure_cond(True, 'True') and self._set_refwidth(value)
    ...
    @property
    def helper(self):
        return self._get_helper() if self.op == cot_helper else None

    @helper.setter
    def helper(self, value):
        return self._ensure_cond(self.op == cot_helper, 'self.op == cot_helper'
            ) and self._ensure_no_obj(self._get_helper(), 'helper', False
            ) and self._acquire_ownership(value, False) and self._set_helper(
            value)
    ...
    @property
    def string(self):
        return self._get_string() if self.op == cot_str else None

    @string.setter
    def string(self, value):
        return self._ensure_cond(self.op == cot_str, 'self.op == cot_str'
            ) and self._ensure_no_obj(self._get_string(), 'string', False
            ) and self._acquire_ownership(value, False) and self._set_string(
            value)
...
"""
    ...
    @property
    def cblock(self):
        return self._get_cblock() if self.op == cit_block else None

    @cblock.setter
    def cblock(self, value):
        return self._ensure_cond(self.op == cit_block, 'self.op == cit_block'
            ) and self._ensure_no_obj(self._get_cblock(), 'cblock', True
            ) and self._acquire_ownership(value, True) and self._set_cblock(
            value)
    ...
    @property
    def cexpr(self):
        return self._get_cexpr() if self.op == cit_expr else None

    @cexpr.setter
    def cexpr(self, value):
        return self._ensure_cond(self.op == cit_expr, 'self.op == cit_expr'
            ) and self._ensure_no_obj(self._get_cexpr(), 'cexpr', True
            ) and self._acquire_ownership(value, True) and self._set_cexpr(
            value)
    ...
    @property
    def cif(self):
        return self._get_cif() if self.op == cit_if else None

    @cif.setter
    def cif(self, value):
        return self._ensure_cond(self.op == cit_if, 'self.op == cit_if'
            ) and self._ensure_no_obj(self._get_cif(), 'cif', True
            ) and self._acquire_ownership(value, True) and self._set_cif(value)
    ...
    @property
    def cfor(self):
        return self._get_cfor() if self.op == cit_for else None

    @cfor.setter
    def cfor(self, value):
        return self._ensure_cond(self.op == cit_for, 'self.op == cit_for'
            ) and self._ensure_no_obj(self._get_cfor(), 'cfor', True
            ) and self._acquire_ownership(value, True) and self._set_cfor(value
            )
    ...
    @property
    def cwhile(self):
        return self._get_cwhile() if self.op == cit_while else None

    @cwhile.setter
    def cwhile(self, value):
        return self._ensure_cond(self.op == cit_while, 'self.op == cit_while'
            ) and self._ensure_no_obj(self._get_cwhile(), 'cwhile', True
            ) and self._acquire_ownership(value, True) and self._set_cwhile(
            value)
    ...
    @property
    def cdo(self):
        return self._get_cdo() if self.op == cit_do else None

    @cdo.setter
    def cdo(self, value):
        return self._ensure_cond(self.op == cit_do, 'self.op == cit_do'
            ) and self._ensure_no_obj(self._get_cdo(), 'cdo', True
            ) and self._acquire_ownership(value, True) and self._set_cdo(value)
    ...
    @property
    def cswitch(self):
        return self._get_cswitch() if self.op == cit_switch else None

    @cswitch.setter
    def cswitch(self, value):
        return self._ensure_cond(self.op == cit_switch, 'self.op == cit_switch'
            ) and self._ensure_no_obj(self._get_cswitch(), 'cswitch', True
            ) and self._acquire_ownership(value, True) and self._set_cswitch(
            value)
    ...
    @property
    def creturn(self):
        return self._get_creturn() if self.op == cit_return else None

    @creturn.setter
    def creturn(self, value):
        return self._ensure_cond(self.op == cit_return, 'self.op == cit_return'
            ) and self._ensure_no_obj(self._get_creturn(), 'creturn', True
            ) and self._acquire_ownership(value, True) and self._set_creturn(
            value)
    ...
    @property
    def cgoto(self):
        return self._get_cgoto() if self.op == cit_goto else None

    @cgoto.setter
    def cgoto(self, value):
        return self._ensure_cond(self.op == cit_goto, 'self.op == cit_goto'
            ) and self._ensure_no_obj(self._get_cgoto(), 'cgoto', True
            ) and self._acquire_ownership(value, True) and self._set_cgoto(
            value)
    ...
    @property
    def casm(self):
        return self._get_casm() if self.op == cit_asm else None

    @casm.setter
    def casm(self, value):
        return self._ensure_cond(self.op == cit_asm, 'self.op == cit_asm'
            ) and self._ensure_no_obj(self._get_casm(), 'casm', True
            ) and self._acquire_ownership(value, True) and self._set_casm(value
            )
...
class catchexpr_t(object):
    ...
    """the caught object. if obj.op==cot_empty, no object. ideally, obj.op==cot_var 
        """
    fake_type: str = property(_ida_hexrays.catchexpr_t_fake_type_get,
...
"""
    is_wind: bool = property(_ida_hexrays.ctry_t_is_wind_get, _ida_hexrays.
        ctry_t_is_wind_set)
...
"""
        return _ida_hexrays.ctree_visitor_t_parent_item(self)
...
class ctree_anchor_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    value: int = property(_ida_hexrays.ctree_anchor_t_value_get,
...
class cfunc_t(object):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError('No constructor defined')
    __repr__ = _swig_repr
    entry_ea: ida_idaapi.ea_t = property(_ida_hexrays.cfunc_t_entry_ea_get,
...
:returns: reference to the vector of warnings"""
    ...
    def recalc_item_addresses(self) ->None:
        ...
        """
        return _ida_hexrays.cfunc_t_recalc_item_addresses(self)
...
"""Comment got changed. 
          """
hxe_mba_maturity = _ida_hexrays.hxe_mba_maturity
"""Maturity level of an MBA was changed. 
          """
...
class history_item_t(ctext_position_t):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    func_ea: ida_idaapi.ea_t = property(_ida_hexrays.
        history_item_t_func_ea_get, _ida_hexrays.history_item_t_func_ea_set)
    """The entry address of the decompiled function.
"""
    curr_ea: ida_idaapi.ea_t = property(_ida_hexrays.
        history_item_t_curr_ea_get, _ida_hexrays.history_item_t_curr_ea_set)
    """Current address.
"""
    end: ida_idaapi.ea_t = property(_ida_hexrays.history_item_t_end_get,
...
:returns: true: The window is locked and may have stale info"""
    ...
    view_idx: int = property(_ida_hexrays.vdui_t_view_idx_get, _ida_hexrays
        .vdui_t_view_idx_set)
...
class ui_stroff_op_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    text: str = property(_ida_hexrays.ui_stroff_op_t_text_get, _ida_hexrays
        .ui_stroff_op_t_text_set)
    """any text for the column "Operand" of widget
"""
    offset: int = property(_ida_hexrays.ui_stroff_op_t_offset_get,
...
hx_cfunc_t_recalc_item_addresses = (_ida_hexrays.
    hx_cfunc_t_recalc_item_addresses)
hx_int64_emulator_t_mop_value = _ida_hexrays.hx_int64_emulator_t_mop_value
hx_int64_emulator_t_minsn_value = _ida_hexrays.hx_int64_emulator_t_minsn_value
...
class __cbhooks_t(Hexrays_Hooks):
    ...
    def mba_maturity(self, *args):
        return self.callback(hxe_mba_maturity, *args)
