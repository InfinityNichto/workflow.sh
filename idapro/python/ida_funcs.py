...
"""
    ...
    frame: int = property(_ida_funcs.func_t_frame_get, _ida_funcs.
        func_t_frame_set)
...
"""
    pntqty: int = property(_ida_funcs.func_t_pntqty_get, _ida_funcs.
        func_t_pntqty_set)
...
"""
    ...
    """array of tails, sorted by ea. use func_tail_iterator_t to access function tails. 
        """
    owner: ida_idaapi.ea_t = property(_ida_funcs.func_t_owner_get,
        _ida_funcs.func_t_owner_set)
