...
class array_parameters_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    flags: int = property(_ida_nalt.array_parameters_t_flags_get, _ida_nalt
        .array_parameters_t_flags_set)
    lineitems: int = property(_ida_nalt.array_parameters_t_lineitems_get,
        _ida_nalt.array_parameters_t_lineitems_set)
    """number of items on a line
"""
    alignment: int = property(_ida_nalt.array_parameters_t_alignment_get,
        _ida_nalt.array_parameters_t_alignment_set)
...
class switch_info_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    flags: int = property(_ida_nalt.switch_info_t_flags_get, _ida_nalt.
...
"""
    jumps: ida_idaapi.ea_t = property(_ida_nalt.switch_info_t_jumps_get,
        _ida_nalt.switch_info_t_jumps_set)
    """jump table start address
"""
    values: ida_idaapi.ea_t = property(_ida_nalt.switch_info_t_values_get,
        _ida_nalt.switch_info_t_values_set)
    """values table address (if SWI_SPARSE is set)
"""
    lowcase: int = property(_ida_nalt.switch_info_t_lowcase_get, _ida_nalt.
        switch_info_t_lowcase_set)
    """the lowest value in cases
"""
    defjump: ida_idaapi.ea_t = property(_ida_nalt.switch_info_t_defjump_get,
        _ida_nalt.switch_info_t_defjump_set)
    """default jump address (BADADDR if no default case)
"""
    startea: ida_idaapi.ea_t = property(_ida_nalt.switch_info_t_startea_get,
...
"""
    ind_lowcase: int = property(_ida_nalt.switch_info_t_ind_lowcase_get,
        _ida_nalt.switch_info_t_ind_lowcase_set)

    def get_lowcase(self) ->int:
        return _ida_nalt.switch_info_t_get_lowcase(self)
    elbase: ida_idaapi.ea_t = property(_ida_nalt.switch_info_t_elbase_get,
        _ida_nalt.switch_info_t_elbase_set)
    """element base
"""
...
"""
    ...
    custom: int = property(_ida_nalt.switch_info_t_custom_get, _ida_nalt.
        switch_info_t_custom_set)
...
"""
    ...
    expr_ea: ida_idaapi.ea_t = property(_ida_nalt.switch_info_t_expr_ea_get,
...
class refinfo_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    target: ida_idaapi.ea_t = property(_ida_nalt.refinfo_t_target_get,
        _ida_nalt.refinfo_t_target_set)
    """reference target (BADADDR-none)
"""
    base: ida_idaapi.ea_t = property(_ida_nalt.refinfo_t_base_get,
        _ida_nalt.refinfo_t_base_set)
...
"""
    flags: int = property(_ida_nalt.refinfo_t_flags_get, _ida_nalt.
        refinfo_t_flags_set)
...
"""
    ...
    """for stroff
"""
    strtype: int = property(_ida_nalt.opinfo_t_strtype_get, _ida_nalt.
