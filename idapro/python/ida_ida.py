...
"""
    _new_callcnv: 'callcnv_t' = property(_ida_ida.
        compiler_info_t__new_callcnv_get, _ida_ida.
        compiler_info_t__new_callcnv_set)

    def get_cc(self) ->'callcnv_t':
        return _ida_ida.compiler_info_t_get_cc(self)

    def set_cc(self, cc: 'callcnv_t') ->None:
        return _ida_ida.compiler_info_t_set_cc(self, cc)
...
"""
    ...
    """General idainfo flags 
        """
    database_change_count: int = property(_ida_ida.
...
"""
    af: int = property(_ida_ida.idainfo_af_get, _ida_ida.idainfo_af_set)
    """Analysis flags 
        """
    af2: int = property(_ida_ida.idainfo_af2_get, _ida_ida.idainfo_af2_set)
    """Analysis flags 2 
        """
    baseaddr: int = property(_ida_ida.idainfo_baseaddr_get, _ida_ida.
...
"""
    start_ip: ida_idaapi.ea_t = property(_ida_ida.idainfo_start_ip_get,
        _ida_ida.idainfo_start_ip_set)
    """IP register value at the start of program execution 
        """
    start_ea: ida_idaapi.ea_t = property(_ida_ida.idainfo_start_ea_get,
        _ida_ida.idainfo_start_ea_set)
    """Linear address of program entry point.
"""
    start_sp: ida_idaapi.ea_t = property(_ida_ida.idainfo_start_sp_get,
        _ida_ida.idainfo_start_sp_set)
    """SP register value at the start of program execution 
        """
    main: ida_idaapi.ea_t = property(_ida_ida.idainfo_main_get, _ida_ida.
        idainfo_main_set)
    """address of main()
"""
    min_ea: ida_idaapi.ea_t = property(_ida_ida.idainfo_min_ea_get,
        _ida_ida.idainfo_min_ea_set)
    """current limits of program
"""
    max_ea: ida_idaapi.ea_t = property(_ida_ida.idainfo_max_ea_get,
        _ida_ida.idainfo_max_ea_set)
    """maxEA is excluded
"""
    omin_ea: ida_idaapi.ea_t = property(_ida_ida.idainfo_omin_ea_get,
        _ida_ida.idainfo_omin_ea_set)
    """original minEA (is set after loading the input file)
"""
    omax_ea: ida_idaapi.ea_t = property(_ida_ida.idainfo_omax_ea_get,
        _ida_ida.idainfo_omax_ea_set)
    """original maxEA (is set after loading the input file)
"""
    lowoff: ida_idaapi.ea_t = property(_ida_ida.idainfo_lowoff_get,
        _ida_ida.idainfo_lowoff_set)
    """Low limit for offsets (used in calculation of 'void' operands) 
        """
    highoff: ida_idaapi.ea_t = property(_ida_ida.idainfo_highoff_get,
        _ida_ida.idainfo_highoff_set)
    """High limit for offsets (used in calculation of 'void' operands) 
        """
    maxref: int = property(_ida_ida.idainfo_maxref_get, _ida_ida.
        idainfo_maxref_set)
...
max autogenerated name length (without zero byte) 
    ...
    """Dummy names representation types 
        """
    short_demnames: int = property(_ida_ida.idainfo_short_demnames_get,
        _ida_ida.idainfo_short_demnames_set)
    """short form of demangled names
"""
    long_demnames: int = property(_ida_ida.idainfo_long_demnames_get,
...
"""
    outflags: int = property(_ida_ida.idainfo_outflags_get, _ida_ida.
...
"""
    ...
    """leading zeroes
"""
    strtype: int = property(_ida_ida.idainfo_strtype_get, _ida_ida.
        idainfo_strtype_set)
...
"""
    strlit_sernum: int = property(_ida_ida.idainfo_strlit_sernum_get,
        _ida_ida.idainfo_strlit_sernum_set)
    """serial number
"""
    datatypes: int = property(_ida_ida.idainfo_datatypes_get, _ida_ida.
...
Target compiler 
        """
    abibits: int = property(_ida_ida.idainfo_abibits_get, _ida_ida.
        idainfo_abibits_set)
    """ABI features. Depends on info returned by get_abi_name() Processor modules may modify them in set_compiler 
        """
    appcall_options: int = property(_ida_ida.idainfo_appcall_options_get,
        _ida_ida.idainfo_appcall_options_set)
...
INF_OBSOLETE_CC = _ida_ida.INF_OBSOLETE_CC
...
INF_COMPILER_INFO = _ida_ida.INF_COMPILER_INFO
INF_CALLCNV = _ida_ida.INF_CALLCNV
...
def inf_get_callcnv() ->'callcnv_t':
    return _ida_ida.inf_get_callcnv()


def inf_set_callcnv(_v: 'callcnv_t') ->bool:
    return _ida_ida.inf_set_callcnv(_v)
...
class idbattr_valmap_t(object):
    ...
    valname: str = property(_ida_ida.idbattr_valmap_t_valname_get, _ida_ida
...
class idbattr_info_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    name: str = property(_ida_ida.idbattr_info_t_name_get, _ida_ida.
...
"""
    individual_node: str = property(_ida_ida.
...
"""
    ...
    maxsize: int = property(_ida_ida.idbattr_info_t_maxsize_get, _ida_ida.
