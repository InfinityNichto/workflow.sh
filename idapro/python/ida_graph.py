...
"""
    flags: int = property(_ida_graph.node_info_t_flags_get, _ida_graph.
        node_info_t_flags_set)
    """flags
"""
    ea: ida_idaapi.ea_t = property(_ida_graph.node_info_t_ea_get,
        _ida_graph.node_info_t_ea_set)
    """address
"""
    text: str = property(_ida_graph.node_info_t_text_get, _ida_graph.
...
class rect_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    left: int = property(_ida_graph.rect_t_left_get, _ida_graph.rect_t_left_set
        )
...
class drawable_graph_t(ida_gdl.gdl_graph_t):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    title: str = property(_ida_graph.drawable_graph_t_title_get, _ida_graph
        .drawable_graph_t_title_set)
    """graph title
"""
...
class interactive_graph_t(drawable_graph_t):
    ...
    __repr__ = _swig_repr
    gid: int = property(_ida_graph.interactive_graph_t_gid_get, _ida_graph.
        interactive_graph_t_gid_set)
...
class group_crinfo_t(object):
    ...
    text: str = property(_ida_graph.group_crinfo_t_text_get, _ida_graph.
...
class user_graph_place_t(object):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError('No constructor defined - class is abstract')
    __repr__ = _swig_repr
    node: int = property(_ida_graph.user_graph_place_t_node_get, _ida_graph
