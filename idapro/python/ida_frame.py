...
class stkpnt_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    ea: ida_idaapi.ea_t = property(_ida_frame.stkpnt_t_ea_get, _ida_frame.
        stkpnt_t_ea_set)
    spd: int = property(_ida_frame.stkpnt_t_spd_get, _ida_frame.
        stkpnt_t_spd_set)
...
"""x.dtyp contains correct variable type (for insns like 'lea' this bit must be off). In general, dr_O references do not allow to determine the variable size 
        """
STKVAR_KEEP_EXISTING = _ida_frame.STKVAR_KEEP_EXISTING
...
class xreflist_entry_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v),
        doc='The membership flag')
    __repr__ = _swig_repr
    ea: ida_idaapi.ea_t = property(_ida_frame.xreflist_entry_t_ea_get,
        _ida_frame.xreflist_entry_t_ea_set)
