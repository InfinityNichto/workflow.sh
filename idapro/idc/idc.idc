 ...
 *      Each byte of the analyzed program has 64-bit flags.
 *      (low 8 bits keep the byte value).
 *      These 64 bits are used in get_full_flags/get_flags functions.
 *
...
/// DEPRECATED Delete IDC function hotkey

[[deprecated]] success del_idc_hotkey(string hotkey);
...
/// (for the explanations of 'ea' and 'n' please see \ref op_bin())
///      target - the full value (all 32 bits) of the offset
...
#define   ABI_BIGARG_ALIGN  0x00000004  //   use natural type alignment for argument if the alignment exceeds native word size (e.g. __int64 argument should be 8byte aligned on some 32-bit platforms)
...
#define   CM_CC_GOLANG     0xB0 // GO: regabi
#define   CM_CC_GOSTK      0x100// GO: arguments and return value in stack
...
///      sel      - base paragraph or selector of the segment.
///                 a paragraph is 16byte memory chunk.
///                 If a selector value is specified, the selector should be
///                 already defined.
///      bitness  - 0: 16-bit segment, 1: 32-bit segment, 2: 64-bit segment
...
success add_segm_ex(long startea, long endea, long sel, long bitness, long align, long comb, long flags);
...
// elements of an array. The array index is 64-bit long. Each array
// may keep a set of strings and a set of 64-bit values.
...
///      value   - 64-bit value to store in the array
/// returns: 1-ok, 0-failed
...
#endif
#define PT_FILE       0x00000001  // input is a file name (otherwise a string containing type declarations)
#define PT_SILENT     0x00000002  // silent mode
#define PT_PAKDEF     0x00000000  // default pack value
#define PT_PAK1       0x00000010  // #pragma pack(1)
#define PT_PAK2       0x00000020  // #pragma pack(2)
#define PT_PAK4       0x00000030  // #pragma pack(4)
#define PT_PAK8       0x00000040  // #pragma pack(8)
#define PT_PAK16      0x00000050  // #pragma pack(16)
...
#define PT_REPLACE    0x00000200  // replace the old type
#define PT_RAWARGS    0x00000400  // leave argument names unchanged
                                  // (do not remove underscores)
#define PT_RELAXED    0x00001000  // accept references to unknown namespaces
#define PT_STANDALONE 0x00400000  // parse standalone declaration, only for parse_decls()
#ifdef _notdefinedsymbol
...
#define PROCESS_STARTED    1 // New process started
#define PROCESS_EXITED     2 // Process stopped
#define THREAD_STARTED     3 // New thread started
#define THREAD_EXITED      4 // Thread stopped
#define BREAKPOINT         5 // Breakpoint reached
#define STEP               6 // One instruction executed
#define EXCEPTION          7 // Exception
#define LIB_LOADED         8 // New library loaded
#define LIB_UNLOADED       9 // Library unloaded
#define INFORMATION       10 // User-defined information
#define PROCESS_ATTACHED  11 // Attached to running process
#define PROCESS_DETACHED  12 // Detached from process
#define PROCESS_SUSPENDED 13 // Process has been suspended
#ifdef _notdefinedsymbol
...
#define AS_ALIGN2     0x20000000L       // .align directive expects an exponent rather than a power of 2
                                        // (.align 5 means to align at 32-byte boundary)
